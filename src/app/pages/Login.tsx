        ...
        <div className="bg-white rounded-[8px] border border-slate-200 shadow-sm overflow-hidden">
          ...
          <div className="bg-[#0F172A] px-8 py-8 text-center">
            <div className="flex items-center justify-center gap-2.5 mb-1">
              ...
              <span className="text-[10px] text-slate-500 bg-slate-800 px-1.5 py-0.5 rounded-[3px] self-center">ADMIN</span>
            </div>
          </div>
          ...
          <div className="px-8 py-7">
            ...
            <p className="text-xs text-slate-400 mb-6">계정 정보를 입력하여 로그인하세요.</p>
            ...
            <div className="mt-6 pt-5 border-t border-slate-100 text-center">
              <p className="text-xs text-slate-400 mb-2">매장 관리자이신가요?</p>
              <a
                href="/client/login"
        ...
        {!resetSent ? (
          <div className="space-y-4">
            <p className="text-sm text-slate-500">
              가입 시 등록한 아이디를 입력하시면 관리자에게 비밀번호 재설정을 요청합니다.
            </p>
            <InputField
              label="아이디"
              type="text"

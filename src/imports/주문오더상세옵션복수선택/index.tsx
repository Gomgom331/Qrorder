import svgPaths from "./svg-8bcvl3v0fj";
...
function Group17() {
  return (
    <div className="absolute contents left-[9.31px] top-[563.45px]">
      <Group18 />
      <div className="absolute left-[18.88px] overflow-clip size-[16px] top-[575.56px]" data-name="check_box_outline_blank">
...
function Group22() {
  return (
    <div className="absolute contents left-[317.8px] top-[614.61px]">
      <div className="absolute flex h-[21.391px] items-center justify-center left-[317.8px] top-[614.61px] w-[21.799px]">
        <div className="flex-none rotate-180">
          <div className="bg-[#e5e8ed] h-[21.391px] relative rounded-[2px] w-[21.799px]" />
        </div>
      </div>
      <IcRoundPlus className="absolute left-[322.4px] size-[12.597px] top-[619px]" />
    </div>
  );
}
...
function Group23() {
  return (
    <div className="absolute contents left-[266.68px] top-[614.61px]">
      <div className="absolute flex h-[21.391px] items-center justify-center left-[266.68px] top-[614.61px] w-[21.799px]">
        <div className="flex-none rotate-180">
          <div className="bg-[#e5e8ed] h-[21.391px] relative rounded-[2px] w-[21.799px]" />
        </div>
      </div>
      <IconsCommonsMinus className="absolute h-[14.261px] left-[271.22px] overflow-clip top-[618.17px] w-[12.716px]" />
    </div>
  );
}
...
function Group20() {
  return (
    <div className="absolute contents left-[9.31px] top-[605.48px]">
      <Group21 />
      <div className="absolute left-[18.88px] overflow-clip size-[16px] top-[617.56px]" data-name="check_box_outline_blank" />
      <div className="-translate-x-full -translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Roboto:Medium','Noto_Sans_KR:Medium',sans-serif] font-medium justify-center leading-[0] left-[258.24px] text-[#999] text-[12px] text-right top-[625px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[normal]">+2,000원</p>
      </div>
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Roboto:Medium',sans-serif] font-medium justify-center leading-[0] left-[298.96px] text-[#222] text-[14px] top-[623.94px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
...
function Group19() {
  return (
    <div className="absolute contents left-[9.31px] top-[605.48px]">
      <Group20 />
      <div className="absolute left-[18.88px] overflow-clip size-[16px] top-[617.56px]" data-name="check_box">
        <div className="absolute inset-[12.5%]" data-name="icon">
          <svg className="absolute block inset-0 size-full" fill="none" height="12" preserveAspectRatio="none" viewBox="0 0 12 12" width="12">
...
function Group25() {
  return (
    <div className="absolute contents left-[9.31px] top-[647.5px]">
      <Group26 />
      <div className="absolute left-[18.88px] overflow-clip size-[16px] top-[659.56px]" data-name="check_box_outline_blank">
        <div className="absolute inset-[12.5%]" data-name="icon">
          <svg className="absolute block inset-0 size-full" fill="none" height="12" preserveAspectRatio="none" viewBox="0 0 12 12" width="12">
            <path d={svgPaths.p16eb6a00} fill="#AEAEB2" id="icon" />
          </svg>
...
function Component5() {
  return (
    <div className="content-center flex flex-wrap gap-y-[12px] items-center relative shrink-0 w-full" data-name="설명">
      <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[normal] min-w-px not-italic relative text-[16px] text-white">옵션 복수선택</p>
    </div>
  );
}
...
export default function Component() {
  return (
    <div className="bg-[#f5f5f5] relative size-full" data-name="주문오더 - 상세옵션 (복수선택)">

import svgPaths from "./svg-k9pj3hdyyr";
type DisplayProps = {
  className?: string;
  color?: "white";
  display?: "web";
...
function IPhone() {
  return (
    <div className="bg-white h-[800px] overflow-clip relative shrink-0 w-[360px]" data-name="iPhone 17 - 1">
      ...
      <div className="absolute bg-white border border-[#f2f4f8] border-solid h-[296.801px] left-[0.39px] rounded-tl-[4px] rounded-tr-[4px] shadow-[1px_2px_6px_1px_rgba(0,0,0,0.2)] top-[503.2px] w-[360px]" />
      <Frame4 />
      <Group16 />
      ...
      <div className="absolute cursor-pointer h-[48px] left-[244px] top-[666.11px]" data-name="Button - elevated">
        <div className="flex flex-row items-center justify-center size-full">
          <div className="content-stretch flex items-center justify-center relative size-full">
            <Content9 />
          </div>
...
function Component3() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start py-[10px] relative shrink-0 w-full" data-name="타이틀">
      <Frame />
      <p className="[word-break:break-word] font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[16px] text-white w-[432px]">직원호출</p>
    </div>
  );
}

import svgPaths from "./svg-tv5m2v6p1z";
...
function Group18() {
  return (
    <div className="absolute contents left-[77.5px] top-[361.5px]">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Roboto:Medium','Noto_Sans_KR:Medium',sans-serif] font-medium justify-center leading-[0] left-[77.5px] text-[#222] text-[14px] top-[369.5px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[normal]">주문이 성공적으로 완료되었습니다.</p>
      </div>
    </div>
  );
}
...
function Group2() {
  return (
    <div className="absolute contents left-[-1px] top-[-1px]">
      ...
      <Group18 />
      <p className="[word-break:break-word] absolute font-['Inter:Semi_Bold','Noto_Sans_KR:Bold',sans-serif] font-semibold leading-[normal] left-[138.88px] not-italic text-[#333] text-[18px] top-[329.91px] whitespace-nowrap">주문 완료</p>
    </div>
  );
}
...
function Desktop() {
  return (
    <div className="absolute border border-[#999] border-solid h-[800px] left-[-0.24px] overflow-clip top-0 w-[360px]" data-name="Desktop - 1">
      ...
      <Group1 />
      <Group2 />
      <div className="absolute bg-[#0f62fe] h-[48px] left-[9.62px] top-[405px] w-[339px]" data-name="button">
        <div aria-hidden className="absolute border-2 border-[#0f62fe] border-solid inset-0 pointer-events-none" />
        <div className="flex flex-row items-center justify-center size-full">
          <div className="content-stretch flex items-center justify-center px-[12px] py-[16px] relative size-full">
            <TextContainer14 />
      ...
      <div className="absolute flex h-[58.279px] items-center justify-center left-[6.27px] top-[400.22px] w-[345.033px]">
      ...
      <div className="absolute bg-[#0f62fe] left-[301.88px] min-w-[18px] rounded-[2px] size-[20px] top-[373.64px]" data-name="화면번호">
      ...
      <div className="absolute h-[15.471px] left-[322.52px] top-[386.07px] w-[14.366px]">
...
function Frame() {
  return (
    <div className="content-stretch flex gap-[6px] items-center relative shrink-0 w-full">
      ...
      <p className="[word-break:break-word] font-['Inter:Semi_Bold','Noto_Sans_KR:Bold',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[20px] text-white w-[399px]">주문오더 장바구니 - 주문완료</p>
    </div>
  );
}
...
function Component3() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start py-[10px] relative shrink-0 w-full" data-name="타이틀">
      <Frame />
      <p className="[word-break:break-word] font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[16px] text-white w-[432px]">주문 완료</p>
    </div>
  );
}
...
function Component5() {
  return (
    <div className="content-center flex flex-wrap gap-y-[12px] items-center relative shrink-0 w-full" data-name="설명">
      <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[normal] min-w-px not-italic relative text-[16px] text-white">주문 완료 페이지</p>
    </div>
  );
}
...
function Component13() {
  return (
    <div className="content-center flex flex-[1_0_0] flex-wrap gap-y-[12px] items-center min-w-px relative" data-name="설명">
      <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[normal] min-w-px not-italic relative text-[#222] text-[16px]">확인 버튼 클릭 시 메인페이지(메뉴 리스트)로 이동한다.</p>
    </div>
  );
}
...
export default function Component() {
  return (
    <div className="bg-white relative size-full" data-name="주문오더 - 주문완료">

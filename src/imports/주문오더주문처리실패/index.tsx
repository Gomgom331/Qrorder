import svgPaths from "./svg-t2ydxev7kf";
import imgRectangle54 from "./97217c59240dce23c0a28043fed6874ff05998d8.png";
type DisplayProps = {
  className?: string;
  color?: "white";
  display?: "web";
...
function Group18() {
  return (
    <div className="absolute contents left-[9.5px] top-[368px]">
      <div className="-translate-x-1/2 -translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Roboto:Medium','Noto_Sans_KR:Medium',sans-serif] font-medium justify-center leading-[0] left-[180px] text-[#222] text-[14px] text-center top-[384px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[normal] mb-0 whitespace-pre">{`통신 상태가 불안정하여 연결이 원활하지 않습니다. `}</p>
        <p className="leading-[normal] whitespace-pre">주변 환경이나 통신 상태를 확인하신 후 다시 시도해 주세요.</p>
      </div>
    </div>
  );
}
...
function Group19() {
  return (
    <div className="absolute contents left-[83px] top-[338.7px]">
      <p className="[word-break:break-word] absolute font-['Inter:Semi_Bold','Noto_Sans_KR:Bold',sans-serif] font-semibold leading-[normal] left-[84px] not-italic text-[#333] text-[18px] top-[339.7px] whitespace-nowrap">연결이 원활하지 않습니다</p>
    </div>
  );
}
...
function IPhone() {
  return (
    <div className="bg-white flex-[1_0_0] h-[800px] min-w-px overflow-clip relative" data-name="iPhone 17 - 1">
      ...
      <Desktop />
      <Frame6 />
      <div className="absolute bg-[#0f62fe] h-[48px] left-[10.38px] top-[426.26px] w-[339px]" data-name="button">
        <div aria-hidden className="absolute border-2 border-[#0f62fe] border-solid inset-0 pointer-events-none" />
        <div className="flex flex-row items-center justify-center size-full">
          <div className="content-stretch flex items-center justify-center px-[12px] py-[16px] relative size-full">
            <TextContainer14 />
      ...
      <div className="absolute flex h-[53.387px] items-center justify-center left-[7.03px] top-[423.57px] w-[345.033px]">
        <div className="-scale-y-100 flex-none">
          <div className="h-[53.387px] relative w-[345.033px]">
            <img alt="" className="absolute block inset-0 max-w-none size-full" height="53.387" src={imgRectangle54} width="345.033" />
          </div>
        </div>
      </div>
      <div className="absolute bg-[#0f62fe] left-[301.64px] min-w-[18px] rounded-[2px] size-[20px] top-[480.5px]" data-name="화면번호">
      ...
      <div className="absolute h-[16.153px] left-[322.28px] top-[476.78px] w-[14.366px]">
...
function Frame() {
  return (
    <div className="content-stretch flex gap-[6px] items-center relative shrink-0 w-full">
      ...
      <p className="[word-break:break-word] font-['Inter:Semi_Bold','Noto_Sans_KR:Bold',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[20px] text-white w-[399px]">주문오더 네트워크 오류</p>
    </div>
  );
}
...
function Component3() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start py-[10px] relative shrink-0 w-full" data-name="타이틀">
      <Frame />
      <p className="[word-break:break-word] font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[16px] text-white w-[432px]">네트워크 오튜</p>
    </div>
  );
}
...
function Component5() {
  return (
    <div className="content-center flex flex-wrap gap-y-[12px] items-center relative shrink-0 w-full" data-name="설명">
      <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[normal] min-w-px not-italic relative text-[16px] text-white">네트워크 지연 등으로 인해 통신이 안 된 경우</p>
    </div>
  );
}
    ...
    <div className="relative shrink-0 w-full" data-name="컨텐츠-번호">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[10px] items-center px-[20px] relative size-full">
          <Component10 />
          <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Semi_Bold','Noto_Sans_KR:Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#666] text-[18px]">다시 시도하기</p>
        </div>
      </div>
    </div>
  );
...
function Component13() {
  return (
    <div className="content-center flex flex-[1_0_0] flex-wrap gap-y-[12px] items-center min-w-px relative" data-name="설명">
      <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[normal] min-w-px not-italic relative text-[#222] text-[16px]">클릭 시 연결 상태 재확인 후 메인페이지로 이동한다.</p>
    </div>
  );
}

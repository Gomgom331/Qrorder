...
import svgPaths from "./svg-ujgi9wpd81";
...
function Desktop1Image({ additionalClassNames = "" }: Desktop1ImageProps) {
  return (
    <div className={clsx("absolute h-[49px] top-[99px] w-[102px]", additionalClassNames)}>
...
export default function Component() {
  return (
    <div className="bg-white relative size-full" data-name="결제 요금 관리">
      <div className="content-stretch flex items-start relative size-full">
        <div className="h-[1024px] relative shrink-0 w-[1440px]" data-name="Desktop - 1">
          <div className="overflow-clip relative rounded-[inherit] size-full">
            <div className="absolute content-stretch flex gap-[8px] h-[48px] items-center justify-center left-[56.5px] py-[16px] top-[167px]" data-name="tab">
            ...
            <div className="absolute content-stretch flex gap-[6px] items-center leading-[0] left-[56.5px] text-[14px] top-[60.34px]">
              ...
              <div className="flex flex-col font-['Roboto:Medium','Noto_Sans_KR:Medium',sans-serif] font-medium justify-center relative shrink-0 text-[#222] w-[96px]" style={{ fontVariationSettings: "'wdth' 100" }}>
                <p className="leading-[normal]">결제요금관리</p>
              </div>
            </div>
            ...
            <div className="absolute bg-white h-[752px] left-[51px] top-[220px] w-[1354px]" data-name="Table">
              <div className="content-stretch flex flex-col items-start overflow-clip relative rounded-[inherit] size-full">
                <div className="bg-[rgba(255,255,255,0)] content-stretch flex h-[48px] items-end overflow-clip relative shrink-0 w-full" data-name=".Row #Table-Fixed-Row">
                  ...
                  <div className="flex flex-[1_0_0] flex-row items-end self-stretch">
                    <div className="bg-[#f2f4f8] content-stretch flex flex-[1_0_0] flex-col h-full items-start justify-center min-h-px min-w-px relative" data-name="Cell">
                      <div aria-hidden="true" className="absolute border-[#dde1e6] border-solid border-t inset-0 pointer-events-none" />
                      <ContentText text="결제 요금 명" />
                    </div>
                  </div>
                  <div className="flex flex-[1_0_0] flex-row items-end self-stretch">
                    <div className="bg-[#f2f4f8] content-stretch flex flex-[1_0_0] flex-col h-full items-start justify-center min-h-px min-w-px relative" data-name="Cell">
                      <div aria-hidden="true" className="absolute border-[#dde1e6] border-solid border-t inset-0 pointer-events-none" />
                      <ContentText text="결제 요금" />
                    </div>
                  </div>
                  <div className="flex flex-[1_0_0] flex-row items-end self-stretch">
                    <div className="bg-[#f2f4f8] content-stretch flex flex-[1_0_0] flex-col h-full items-start justify-center min-h-px min-w-px relative" data-name="Cell">
                      <div aria-hidden="true" className="absolute border-[#dde1e6] border-solid border-t inset-0 pointer-events-none" />
                      <ContentText text="결제 요금 단위" />
                    </div>
                  </div>
                  <div className="flex flex-[1_0_0] flex-row items-end self-stretch">
                    <div className="bg-[#f2f4f8] content-stretch flex flex-[1_0_0] flex-col h-full items-start justify-center min-h-px min-w-px relative" data-name="Cell">
                      <div aria-hidden="true" className="absolute border-[#dde1e6] border-solid border-t inset-0 pointer-events-none" />
                      <ContentText text="라이센스기간(월)" />
                    </div>
                  </div>
                  <div className="flex flex-row items-end self-stretch">
            ...
            <div className="absolute content-stretch flex gap-[12px] items-center left-[1009px] top-[100px]">
            ...
            <Desktop1Text text="2" additionalClassNames="left-[1011px] top-[75px]" />
            <Desktop1Image additionalClassNames="left-[1009px]" />
            <Desktop1Text text="4" additionalClassNames="left-[1118px] top-[75px]" />
            <Desktop1Image additionalClassNames="left-[1116px]" />
            <Desktop1Text text="6" additionalClassNames="left-[1217px] top-[75px]" />
            <Desktop1Image additionalClassNames="left-[1215px]" />
            <div className="absolute border-2 border-[#0f62fe] border-dashed h-[30.834px] left-[1368px] top-[276.83px] w-[31.94px]" />
            <Desktop1Text text="5" additionalClassNames="left-[1301.16px] top-[239px]" />
            <div className="-translate-x-1/2 -translate-y-1/2 absolute flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] left-[1364.82px] not-italic text-[#0f62fe] text-[12px] text-center top-[249px] whitespace-nowrap">
              <p className="leading-[normal]">{` `}</p>
            </div>
            <div className="absolute h-[33.409px] left-[1312.61px] top-[259.3px] w-[52.219px]">
              ...
              <div className="content-stretch flex flex-col gap-[8px] items-start justify-center min-h-[inherit] p-[20px] relative w-full">
                <div className="content-stretch flex flex-col gap-[10px] items-start py-[10px] relative shrink-0 w-full" data-name="타이틀">
                  <div className="content-stretch flex gap-[6px] items-center relative shrink-0 w-full">
                    ...
                    <p className="font-['Inter:Semi_Bold','Noto_Sans_KR:Bold',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[20px] text-white w-[400px]">결제 요금 관리</p>
                  </div>
                  <p className="font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[16px] text-white w-[432px]">시스템/결제관리/결제요금관리</p>
                </div>
          ...
          <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="화면구성-컨텐츠">
            ...
            <div className="content-stretch flex flex-col gap-[10px] items-start justify-center py-[10px] relative shrink-0 w-full" data-name="컨텐츠-박스">
              ...
              <div className="relative shrink-0 w-full" data-name="컨텐츠-내용">
                <div className="flex flex-row items-center size-full">
                  <div className="content-stretch flex items-center px-[20px] relative w-full">
                    <Text1 text="신규 버튼 클릭 시 결제요금 데이터를 등록 할 수 있는 신규 팝업이 등장한다." />
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="화면구성-컨텐츠">
            ...
            <div className="content-stretch flex flex-col gap-[10px] items-start justify-center py-[10px] relative shrink-0 w-full" data-name="컨텐츠-박스">
              ...
              <div className="relative shrink-0 w-full" data-name="컨텐츠-내용">
                <div className="flex flex-row items-center size-full">
                  <div className="content-stretch flex items-center px-[20px] relative w-full">
                    <Text1 text="생성된 결제요금 데이터를 리스트 우측 수정 아이콘을 누를시 수정 팝업이 등장한다." />
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="화면구성-컨텐츠">
            ...
            <div className="content-stretch flex flex-col gap-[10px] items-start justify-center py-[10px] relative shrink-0 w-full" data-name="컨텐츠-박스">
              ...
              <div className="relative shrink-0 w-full" data-name="컨텐츠-내용">
                <div className="flex flex-row items-center size-full">
                  <div className="content-stretch flex items-center px-[20px] relative w-full">
                    <Text1 text="체크박스 선택 후 삭제 버튼 클릭 시, 선택한 마스터코드 데이터에 대한 삭제 진행 전, Confirm 팝업이 등장한다." />
                  </div>
                </div>
              </div>
            </div>

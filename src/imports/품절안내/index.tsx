import svgPaths from "./svg-3ontst1tbo";
  ...
  return (
    <div className="relative shrink-0 size-[18px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" height="18" preserveAspectRatio="none" viewBox="0 0 18 18" width="18">
        <g clipPath="url(#clip0_0_40)" id="Icon">
...
function Paragraph23() {
  return (
    <div className="content-stretch flex flex-[301.125_0_0] flex-col items-start min-w-px relative" data-name="Paragraph">
      <p className="[word-break:break-word] font-['Pretendard:SemiBold',sans-serif] leading-[19.25px] not-italic relative shrink-0 text-[#1d293d] text-[14px] whitespace-nowrap">비빔밥</p>
    </div>
  );
}
...
function Text20() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Text">
      <p className="[word-break:break-word] font-['Pretendard:Regular',sans-serif] leading-[16px] not-italic relative shrink-0 text-[#90a1b9] text-[12px] whitespace-nowrap">9,000원</p>
    </div>
  );
}
...
function Icon25() {
  return (
    <div className="relative shrink-0 size-[11px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" height="11" preserveAspectRatio="none" viewBox="0 0 11 11" width="11">
        <g id="Icon">
          <path d="M2.29167 5.5H8.70833" id="Vector" stroke="#62748E" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.14583" />
        </g>
      </svg>
    </div>
  );
...
function Button22() {
  return (
    <div className="bg-[#f1f5f9] content-stretch flex items-center justify-center relative rounded-[4px] shrink-0 size-[28px]" data-name="Button - 수량 감소">
      <Icon25 />
    </div>
  );
}
...
function Text21() {
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0 w-[24px]" data-name="Text">
      <p className="[word-break:break-word] font-['Pretendard:SemiBold',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#1d293d] text-[14px] text-center whitespace-nowrap">3</p>
    </div>
  );
}
...
function Button26() {
  return (
    <div className="bg-[#ff6b2b] content-stretch flex h-[48px] items-center justify-center relative rounded-[6px] shrink-0 w-[371px]" data-name="Button">
...
function CartSheet() {
  return (
    <div className="absolute bg-[rgba(0,0,0,0.5)] h-[840px] left-0 top-0 w-[403px]" data-name="CartSheet">
      <Container77 />
      <div className="absolute bg-[rgba(0,0,0,0.25)] h-[840px] left-0 top-0 w-[403px]" />
    </div>
  );
}
...
function SoldoutModal() {
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0 w-full" data-name="SoldoutModal">
      <p className="[word-break:break-word] font-['Pretendard:SemiBold',sans-serif] leading-[20.625px] not-italic relative shrink-0 text-[#222] text-[15px] text-center whitespace-nowrap">주문할 수 없는 메뉴가 있습니다</p>
    </div>
  );
}
...
function SoldoutModal1() {
  return (
    <div className="content-stretch flex flex-col h-[24px] items-center pt-[4px] relative shrink-0 w-[232px]" data-name="SoldoutModal">
      <p className="[word-break:break-word] font-['Pretendard:Regular',sans-serif] leading-[19.5px] not-italic relative shrink-0 text-[#999] text-[13px] text-center whitespace-nowrap">품절된 메뉴를 확인해 주세요.</p>
    </div>
  );
}

function Text26() {
  return <div className="bg-[#ff6467] relative rounded-[33554400px] shrink-0 size-[6px]" data-name="Text" />;
}

function Paragraph28() {
  return (
    <div className="content-stretch flex flex-col h-[18px] items-start overflow-clip relative shrink-0 w-[31.125px]" data-name="Paragraph">
      <p className="[word-break:break-word] font-['Pretendard:Regular',sans-serif] leading-[18px] not-italic relative shrink-0 text-[#45556c] text-[12px] whitespace-nowrap">비빔밥</p>
    </div>
  );
}
...
function Text27() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Text">
      <p className="[word-break:break-word] font-['Pretendard:Medium',sans-serif] leading-[16.5px] not-italic relative shrink-0 text-[#ff6467] text-[11px] whitespace-nowrap">품절</p>
    </div>
  );
}
...
function SoldoutModal3() {
  return (
    <div className="bg-[#ff6b2b] h-[40px] relative rounded-[6px] shrink-0 w-full" data-name="SoldoutModal">
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Pretendard:SemiBold',sans-serif] leading-[20px] left-[116.39px] not-italic text-[14px] text-center text-white top-[10px] whitespace-nowrap">확인</p>
    </div>
  );
}
...
function Container93() {
  return (
    <div className="absolute bg-white content-stretch drop-shadow-[0px_25px_25px_rgba(0,0,0,0.25)] flex flex-col items-start left-[61.5px] max-w-[280px] p-[24px] rounded-[12px] top-[318.5px] w-[280px]" data-name="Container">
      <SoldoutModal />
      <SoldoutModal1 />
      <SoldoutModalMargin />
      <SoldoutModal3 />

import svgPaths from "./svg-x9j7mvy106";
import imgRectangle56 from "./bab474f15a2a4c95ea74a8b44e895bbde0f102f6.png";
...
import imgRectangle57 from "./33c862a05aa287fc5100e9b9bf2310218ed26b39.png";
import imgRectangle58 from "./f34b1f9cd15e3745c71303c255cfb6089f876463.png";
type DisplayProps = {
  className?: string;
  color?: "white";
  display?: "web";
...
function ScrollbarVertical({ className, pageHeight = "x 2", position = "Top" }: ScrollbarVerticalProps) {
  return (
    <div className={className || "h-[64px] overflow-clip relative w-[12px]"}>
...
function Group16() {
  return (
    <div className="absolute contents left-[324.19px] top-[720.11px]">
      <div className="absolute flex h-[21.391px] items-center justify-center left-[324.19px] top-[720.11px] w-[21.799px]">
        <div className="flex-none rotate-180">
          <div className="bg-[#e5e8ed] h-[21.391px] relative rounded-[2px] w-[21.799px]" />
        </div>
      </div>
      <IcRoundPlus className="absolute left-[328.79px] size-[12.597px] top-[724.51px]" />
    </div>
  );
}
...
function Group17() {
  return (
    <div className="absolute contents left-[273.07px] top-[720.11px]">
      <div className="absolute flex h-[21.391px] items-center justify-center left-[273.07px] top-[720.11px] w-[21.799px]">
        <div className="flex-none rotate-180">
          <div className="bg-[#e5e8ed] h-[21.391px] relative rounded-[2px] w-[21.799px]" />
        </div>
      </div>
      <IconsCommonsMinus className="absolute h-[14.261px] left-[277.61px] overflow-clip top-[723.68px] w-[12.716px]" />
    </div>
  );
}
...
function Group23() {
  return (
    <div className="absolute contents left-[18.88px] top-[433.56px]">
      <div className="absolute left-[18.88px] overflow-clip size-[16px] top-[433.56px]" data-name="radio_button_checked">
        <div className="absolute inset-[8.33%]" data-name="icon">
          <svg className="absolute block inset-0 size-full" fill="none" height="13.3333" preserveAspectRatio="none" viewBox="0 0 13.3333 13.3333" width="13.3333">
            <path d={svgPaths.p11079600} fill="#AEAEB2" id="icon" />
          </svg>
        </div>
      </div>
    </div>
...
function Group20() {
  return (
    <div className="absolute contents left-[9.31px] top-[421.11px]">
      <div className="absolute bg-white border border-[#e5e8ed] border-solid h-[40px] left-[9.31px] rounded-[4px] top-[421.11px] w-[340.432px]" />
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Roboto:Medium','Noto_Sans_KR:Medium',sans-serif] font-medium justify-center leading-[0] left-[45px] text-[#222] text-[12px] top-[440.22px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[normal]">옵션 명</p>
      </div>
      <Group21 />
      <div className="-translate-x-full -translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Roboto:Medium','Noto_Sans_KR:Medium',sans-serif] font-medium justify-center leading-[0] left-[339.59px] text-[#999] text-[12px] text-right top-[441.45px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
...
function Group26() {
  return (
    <div className="absolute contents left-[9.31px] top-[463.14px]">
      <div className="absolute bg-white border border-[#e5e8ed] border-solid h-[40px] left-[9.31px] rounded-[4px] top-[463.14px] w-[340.432px]" />
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Roboto:Medium','Noto_Sans_KR:Medium',sans-serif] font-medium justify-center leading-[0] left-[45px] text-[#222] text-[12px] top-[482.25px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[normal]">옵션 명</p>
      </div>
    </div>
  );
...
function Group25() {
  return (
    <div className="absolute contents left-[9.31px] top-[463.14px]">
      <Group26 />
      <div className="absolute left-[18.42px] overflow-clip size-[16px] top-[474.11px]" data-name="radio_button_unchecked">
        <div className="absolute inset-[8.33%]" data-name="icon">
          <svg className="absolute block inset-0 size-full" fill="none" height="13.3333" preserveAspectRatio="none" viewBox="0 0 13.3333 13.3333" width="13.3333">
      ...
      <div className="-translate-x-full -translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Roboto:Medium','Noto_Sans_KR:Medium',sans-serif] font-medium justify-center leading-[0] left-[339.59px] text-[#999] text-[12px] text-right top-[483.45px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
...
function Group29() {
  return (
    <div className="absolute contents left-[9.31px] top-[505.17px]">
      <div className="absolute bg-white border border-[#e5e8ed] border-solid h-[40px] left-[9.31px] rounded-[4px] top-[505.17px] w-[340.432px]" />
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Roboto:Medium','Noto_Sans_KR:Medium',sans-serif] font-medium justify-center leading-[0] left-[45px] text-[#222] text-[12px] top-[524.28px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[normal]">옵션 명</p>
      </div>
    </div>
  );
...
function Group28() {
  return (
    <div className="absolute contents left-[9.31px] top-[505.17px]">
      <Group29 />
      <div className="absolute left-[18.42px] overflow-clip size-[16px] top-[516.14px]" data-name="radio_button_unchecked">
        <div className="absolute inset-[8.33%]" data-name="icon">
          <svg className="absolute block inset-0 size-full" fill="none" height="13.3333" preserveAspectRatio="none" viewBox="0 0 13.3333 13.3333" width="13.3333">
            <path d={svgPaths.p3c2cf080} fill="#AEAEB2" id="icon" />
          </svg>
...
function Group27() {
  return (
    <div className="absolute contents left-[9.31px] top-[505.17px]">
      <Group28 />
      <div className="-translate-x-full -translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Roboto:Medium','Noto_Sans_KR:Medium',sans-serif] font-medium justify-center leading-[0] left-[339.59px] text-[#999] text-[12px] text-right top-[525.45px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
...
function Frame4() {
  return (
    <div className="absolute content-stretch flex items-center justify-center left-[10.74px] top-[748.5px] w-[339px]">
      <Button />
    </div>
  );
}
...
function Group32() {
  return (
    <div className="absolute contents left-[9.31px] top-[582px]">
      <div className="absolute bg-white border border-[#e5e8ed] border-solid h-[40px] left-[9.31px] rounded-[4px] top-[582px] w-[340.432px]" />
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Roboto:Medium','Noto_Sans_KR:Medium',sans-serif] font-medium justify-center leading-[0] left-[45px] text-[#222] text-[12px] top-[601.11px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[normal]">옵션 명</p>
      </div>
      <div className="-translate-x-full -translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Roboto:Medium','Noto_Sans_KR:Medium',sans-serif] font-medium justify-center leading-[0] left-[258.24px] text-[#999] text-[12px] text-right top-[602px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[normal]">+1,000원</p>
      </div>
    </div>
  );
...
function Group33() {
  return (
    <div className="absolute contents left-[317.8px] top-[591.61px]">
      <div className="absolute flex h-[21.391px] items-center justify-center left-[317.8px] top-[591.61px] w-[21.799px]">
        <div className="flex-none rotate-180">
          <div className="bg-[#e5e8ed] h-[21.391px] relative rounded-[2px] w-[21.799px]" />
        </div>
      </div>
      <IcRoundPlus className="absolute left-[322.4px] size-[12.597px] top-[596px]" />
    </div>
  );
}
...
function Group34() {
  return (
    <div className="absolute contents left-[266.68px] top-[591.61px]">
      <div className="absolute flex h-[21.391px] items-center justify-center left-[266.68px] top-[591.61px] w-[21.799px]">
        <div className="flex-none rotate-180">
          <div className="bg-[#e5e8ed] h-[21.391px] relative rounded-[2px] w-[21.799px]" />
        </div>
      </div>
      <IconsCommonsMinus className="absolute h-[14.261px] left-[271.22px] overflow-clip top-[595.17px] w-[12.716px]" />
    </div>
  );
}
...
function Group31() {
  return (
    <div className="absolute contents left-[9.31px] top-[582px]">
      <Group32 />
      <div className="absolute left-[18.88px] overflow-clip size-[16px] top-[594.11px]" data-name="check_box">
        <div className="absolute inset-[12.5%]" data-name="icon">
          <svg className="absolute block inset-0 size-full" fill="none" height="12" preserveAspectRatio="none" viewBox="0 0 12 12" width="12">
            <path d={svgPaths.pb523940} fill="#AEAEB2" id="icon" />
          </svg>
        </div>
      </div>
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Roboto:Medium',sans-serif] font-medium justify-center leading-[0] left-[298.96px] text-[#222] text-[14px] top-[600.94px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
...
function Group37() {
  return (
    <div className="absolute contents left-[9.31px] top-[624.03px]">
      <div className="absolute bg-white border border-[#e5e8ed] border-solid h-[40px] left-[9.31px] rounded-[4px] top-[624.03px] w-[340.432px]" />
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Roboto:Medium','Noto_Sans_KR:Medium',sans-serif] font-medium justify-center leading-[0] left-[45px] text-[#222] text-[12px] top-[643.14px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[normal]">옵션 명</p>
      </div>
      <div className="-translate-x-full -translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Roboto:Medium','Noto_Sans_KR:Medium',sans-serif] font-medium justify-center leading-[0] left-[339.59px] text-[#999] text-[12px] text-right top-[644.45px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[normal]">+2,000원</p>
      </div>
    </div>
  );
}
...
function Group36() {
  return (
    <div className="absolute contents left-[9.31px] top-[624.03px]">
      <Group37 />
      <div className="absolute left-[18.88px] overflow-clip size-[16px] top-[636.11px]" data-name="check_box_outline_blank">
        <div className="absolute inset-[12.5%]" data-name="icon">
          <svg className="absolute block inset-0 size-full" fill="none" height="12" preserveAspectRatio="none" viewBox="0 0 12 12" width="12">
            <path d={svgPaths.p16eb6a00} fill="#AEAEB2" id="icon" />
          </svg>
        </div>
      </div>
    </div>
...
function Group40() {
  return (
    <div className="absolute contents left-[9.31px] top-[666.05px]">
      <div className="absolute bg-white border border-[#e5e8ed] border-solid h-[40px] left-[9.31px] rounded-[4px] top-[666.05px] w-[340.432px]" />
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Roboto:Medium','Noto_Sans_KR:Medium',sans-serif] font-medium justify-center leading-[0] left-[45px] text-[#222] text-[12px] top-[685.17px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[normal]">옵션 명</p>
      </div>
      <div className="-translate-x-full -translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Roboto:Medium','Noto_Sans_KR:Medium',sans-serif] font-medium justify-center leading-[0] left-[339.59px] text-[#999] text-[12px] text-right top-[686.45px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[normal]">+1,500원</p>
      </div>
    </div>
  );
}
...
function Group39() {
  return (
    <div className="absolute contents left-[9.31px] top-[666.05px]">
      <Group40 />
      <div className="absolute left-[18.88px] overflow-clip size-[16px] top-[678.11px]" data-name="check_box_outline_blank">
        <div className="absolute inset-[12.5%]" data-name="icon">
          <svg className="absolute block inset-0 size-full" fill="none" height="12" preserveAspectRatio="none" viewBox="0 0 12 12" width="12">
            <path d={svgPaths.p16eb6a00} fill="#AEAEB2" id="icon" />
          </svg>
...
function IPhone() {
  return (
    <div className="bg-white h-[820px] overflow-clip relative shrink-0 w-[360px]" data-name="iPhone 17 - 1">
      <Frame1 />
      <Frame2 />
      <Frame3 />
      ...
      <div className="absolute bg-white border border-[#f2f4f8] border-solid h-[801.001px] left-0 rounded-tl-[4px] rounded-tr-[4px] shadow-[1px_2px_6px_1px_rgba(0,0,0,0.2)] top-[18.67px] w-[360px]" />
      <div className="absolute h-[24.392px] left-[266.96px] top-[718.11px] w-[87.086px]">
        <img alt="" className="absolute block inset-0 max-w-none size-full" height="24.392" src={imgRectangle56} width="87.086" />
      </div>
      <div className="absolute flex h-[26.488px] items-center justify-center left-[221.34px] top-[255.82px] w-[129.603px]">
      ...
      <div className="absolute bg-[#0f62fe] left-[194px] min-w-[18px] rounded-[2px] size-[20px] top-[258.32px]" data-name="화면번호">
      ...
      <div className="absolute flex h-[26.488px] items-center justify-center left-[7.09px] top-[255.51px] w-[54.877px]">
        <div className="-scale-y-100 flex-none">
      ...
      <div className="absolute bg-[#0f62fe] left-[67.88px] min-w-[18px] rounded-[2px] size-[20px] top-[259.55px]" data-name="화면번호">
        <div aria-hidden className="absolute border-2 border-[#195edf] border-solid inset-[-1px] pointer-events-none rounded-[3px]" />
        <div className="flex flex-row items-center justify-center min-w-[inherit] size-full">
          <div className="content-stretch flex items-center justify-center min-w-[inherit] px-[6px] relative size-full">
            <div className="[word-break:break-word] flex flex-[1_0_0] flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] min-w-px not-italic relative text-[12px] text-center text-white">
      ...
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Roboto:Medium',sans-serif] font-medium justify-center leading-[0] left-[305.35px] text-[#222] text-[14px] top-[729.45px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[normal]">1</p>
      </div>
      <Group16 />
      <Group17 />
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Roboto:Medium','Noto_Sans_KR:Medium',sans-serif] font-medium justify-center leading-[0] left-[16.14px] text-[#222] text-[14px] top-[728.11px] w-[93.86px]" style={{ fontVariationSettings: '"wdth" 100' }}>
      ...
      <Group27 />
      <Frame4 />
      <div className="absolute h-0 left-[9.31px] top-[385.09px] w-[338.689px]">
        <div className="absolute inset-[-0.5px_0]">
      ...
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Pretendard:Regular',sans-serif] justify-center leading-[0] left-[9.31px] not-italic text-[#444] text-[12px] top-[350.13px] w-[334.234px]">
      ...
      <div className="absolute bg-[#e5e8ed] h-[22px] left-[224px] top-[258.05px] w-[60px]" data-name="button">
        <div aria-hidden className="absolute border border-[#e5e8ed] border-solid inset-0 pointer-events-none" />
        <div className="flex flex-row items-center justify-center size-full">
          <div className="content-stretch flex items-center justify-center px-[12px] py-[16px] relative size-full">
            <TextContainer12 />
      ...
      <div className="absolute bg-[#e5e8ed] h-[22px] left-[288px] top-[258.05px] w-[60px]" data-name="button">
        <div aria-hidden className="absolute border border-[#e5e8ed] border-solid inset-0 pointer-events-none" />
        <div className="flex flex-row items-center justify-center size-full">
          <div className="content-stretch flex items-center justify-center px-[12px] py-[16px] relative size-full">
            <TextContainer13 />
      ...
      <div className="absolute bg-[#e5e8ed] h-[22px] left-[307.74px] top-[392.11px] w-[42px]" data-name="button">
        <div aria-hidden className="absolute border border-[#e5e8ed] border-solid inset-0 pointer-events-none" />
        <div className="flex flex-row items-center justify-center size-full">
          <div className="content-stretch flex items-center justify-center px-[12px] py-[16px] relative size-full">
            <TextContainer14 />
      ...
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Roboto:Medium','Noto_Sans_KR:Medium',sans-serif] font-medium justify-center leading-[0] left-[9.31px] text-[#222] text-[16px] top-[269.55px] w-[96px]" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[normal]">메뉴 명</p>
      </div>
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Roboto:Bold','Noto_Sans_KR:Bold',sans-serif] font-bold justify-center leading-[0] left-[283.97px] text-[#0f62fe] text-[16px] top-[299.55px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[normal]">39,000원</p>
      </div>
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Roboto:Medium','Noto_Sans_KR:Medium',sans-serif] font-medium justify-center leading-[0] left-[9.31px] text-[#222] text-[12px] top-[403.11px] w-[96px]" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[normal]">옵션 카테고리</p>
      </div>
      <div className="absolute bg-[#e5e8ed] h-[200px] left-[-0.12px] top-[43.93px] w-[360px]" data-name="button">
        <div aria-hidden className="absolute border border-[#e5e8ed] border-solid inset-0 pointer-events-none" />
        <div className="flex flex-row items-center justify-center size-full">
          <div className="content-stretch flex items-center justify-center px-[12px] py-[16px] relative size-full" />
        </div>
      </div>
      <div className="absolute bg-[#e5e8ed] h-[4.274px] left-[122.73px] rounded-[10px] top-[28.73px] w-[114.539px]" />
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Roboto:Medium','Noto_Sans_KR:Medium',sans-serif] font-medium justify-center leading-[0] left-[9.31px] text-[#222] text-[12px] top-[564px] w-[96px]" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[normal]">옵션 카테고리</p>
      </div>
      <Group30 />
      <Group35 />
      <Group38 />
      <ScrollbarVertical className="absolute h-[643px] left-[343.88px] overflow-clip top-[9px] w-[14px]" />
      <div className="absolute flex h-[26.488px] items-center justify-center left-[275.13px] top-[285px] w-[75.813px]">
        <div className="-scale-y-100 flex-none">
      ...
      <div className="absolute bg-[#0f62fe] left-[250px] min-w-[18px] rounded-[2px] size-[20px] top-[287.63px]" data-name="화면번호">
        <div aria-hidden className="absolute border-2 border-[#195edf] border-solid inset-[-1px] pointer-events-none rounded-[3px]" />
        <div className="flex flex-row items-center justify-center min-w-[inherit] size-full">
          <div className="content-stretch flex items-center justify-center min-w-[inherit] px-[6px] relative size-full">
            <div className="[word-break:break-word] flex flex-[1_0_0] flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] min-w-px not-italic relative text-[12px] text-center text-white">
      ...
      <div className="absolute flex h-[51.938px] items-center justify-center left-[5.2px] top-[322.64px] w-[340.801px]">
        <div className="-scale-y-100 flex-none">
      ...
      <div className="absolute bg-[#0f62fe] left-[9px] min-w-[18px] rounded-[2px] size-[20px] top-[296.88px]" data-name="화면번호">
        <div aria-hidden className="absolute border-2 border-[#195edf] border-solid inset-[-1px] pointer-events-none rounded-[3px]" />
        <div className="flex flex-row items-center justify-center min-w-[inherit] size-full">
          <div className="content-stretch flex items-center justify-center min-w-[inherit] px-[6px] relative size-full">
            <div className="[word-break:break-word] flex flex-[1_0_0] flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] min-w-px not-italic relative text-[12px] text-center text-white">
      ...
      <div className="absolute bg-[#0f62fe] left-[5px] min-w-[18px] rounded-[2px] size-[20px] top-[51.17px]" data-name="화면번호">
        <div aria-hidden className="absolute border-2 border-[#195edf] border-solid inset-[-1px] pointer-events-none rounded-[3px]" />
        <div className="flex flex-row items-center justify-center min-w-[inherit] size-full">
          <div className="content-stretch flex items-center justify-center min-w-[inherit] px-[6px] relative size-full">
            <div className="[word-break:break-word] flex flex-[1_0_0] flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] min-w-px not-italic relative text-[12px] text-center text-white">
      ...
      <div className="absolute flex h-[132.068px] items-center justify-center left-[5.19px] top-[580.04px] w-[348.862px]">
        <div className="-scale-y-100 flex-none">
      ...
      <div className="absolute bg-[#0f62fe] left-[87.88px] min-w-[18px] rounded-[2px] size-[20px] top-[554.11px]" data-name="화면번호">
        <div aria-hidden className="absolute border-2 border-[#195edf] border-solid inset-[-1px] pointer-events-none rounded-[3px]" />
        <div className="flex flex-row items-center justify-center min-w-[inherit] size-full">
          <div className="content-stretch flex items-center justify-center min-w-[inherit] px-[6px] relative size-full">
            <div className="[word-break:break-word] flex flex-[1_0_0] flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] min-w-px not-italic relative text-[12px] text-center text-white">
      ...
      <div className="absolute flex h-[132.068px] items-center justify-center left-[5.19px] top-[416.53px] w-[348.862px]">
        <div className="-scale-y-100 flex-none">
          <div className="h-[132.068px] relative w-[348.862px]">
            <img alt="" className="absolute block inset-0 max-w-none size-full" height="132.068" src={imgRectangle54} width="348.862" />
          </div>
      ...
      <div className="absolute bg-[#0f62fe] left-[87.88px] min-w-[18px] rounded-[2px] size-[20px] top-[390.6px]" data-name="화면번호">
        <div aria-hidden className="absolute border-2 border-[#195edf] border-solid inset-[-1px] pointer-events-none rounded-[3px]" />
        <div className="flex flex-row items-center justify-center min-w-[inherit] size-full">
          <div className="content-stretch flex items-center justify-center min-w-[inherit] px-[6px] relative size-full">
            <div className="[word-break:break-word] flex flex-[1_0_0] flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] min-w-px not-italic relative text-[12px] text-center text-white">
      ...
      <div className="absolute bg-[#0f62fe] left-[238.74px] min-w-[18px] rounded-[2px] size-[20px] top-[719.45px]" data-name="화면번호">
        <div aria-hidden className="absolute border-2 border-[#195edf] border-solid inset-[-1px] pointer-events-none rounded-[3px]" />
        <div className="flex flex-row items-center justify-center min-w-[inherit] size-full">
          <div className="content-stretch flex items-center justify-center min-w-[inherit] px-[6px] relative size-full">
            <div className="[word-break:break-word] flex flex-[1_0_0] flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] min-w-px not-italic relative text-[12px] text-center text-white">
      ...
      <div className="absolute flex h-[55.438px] items-center justify-center left-[5.2px] top-[744.51px] w-[348.851px]">
        <div className="-scale-y-100 flex-none">
          <div className="h-[55.438px] relative w-[348.851px]">
            <img alt="" className="absolute block inset-0 max-w-none size-full" height="55.438" src={imgRectangle57} width="348.851" />
          </div>
        </div>
      </div>
      <div className="absolute bg-[#0f62fe] left-[77.88px] min-w-[18px] rounded-[2px] size-[20px] top-[719.45px]" data-name="화면번호">
        <div aria-hidden className="absolute border-2 border-[#195edf] border-solid inset-[-1px] pointer-events-none rounded-[3px]" />
        <div className="flex flex-row items-center justify-center min-w-[inherit] size-full">
          <div className="content-stretch flex items-center justify-center min-w-[inherit] px-[6px] relative size-full">
            <div className="[word-break:break-word] flex flex-[1_0_0] flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] min-w-px not-italic relative text-[12px] text-center text-white">
      ...
      <div className="absolute h-[12.063px] left-[57.34px] top-[730.79px] w-[19.301px]">
      ...
      <div className="absolute flex h-[26.488px] items-center justify-center left-[114px] top-[17.62px] w-[132px]">
        <div className="-scale-y-100 flex-none">
          <div className="h-[26.488px] relative w-[132px]">
            <img alt="" className="absolute block inset-0 max-w-none size-full" height="26.488" src={imgRectangle58} width="132" />
          </div>
        </div>
      </div>
      <div className="absolute bg-[#0f62fe] h-[20px] left-[253.88px] min-w-[18px] rounded-[2px] top-[22px] w-[26px]" data-name="화면번호">
        <div aria-hidden className="absolute border-2 border-[#195edf] border-solid inset-[-1px] pointer-events-none rounded-[3px]" />
        <div className="flex flex-row items-center justify-center min-w-[inherit] size-full">
          <div className="content-stretch flex items-center justify-center min-w-[inherit] px-[6px] relative size-full">
            <div className="[word-break:break-word] flex flex-[1_0_0] flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] min-w-px not-italic relative text-[12px] text-center text-white">
...
function Component3() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start py-[10px] relative shrink-0 w-full" data-name="타이틀">
      <Frame />
      <p className="[word-break:break-word] font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[16px] text-white w-[432px]">상세옵션 수량 설정 및 다건</p>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="컨텐츠-번호">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[10px] items-center px-[20px] relative size-full">
          <Component44 />
          <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Semi_Bold','Noto_Sans_KR:Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#666] text-[18px]">메뉴 옵션 - 복수선택</p>
        </div>
      </div>
    </div>
  );
...
function Component46() {
  return (
    <div className="content-center flex flex-[1_0_0] flex-wrap gap-y-[12px] items-center min-w-px relative" data-name="설명">
      <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[normal] min-w-px not-italic relative text-[#222] text-[16px]">해당 옵션 그룹 내에서 사용자가 원하는 항목을 다중(복수)으로 선택할 수 있으며, 옵션 선택 시 개별 수량을 변경할 수 있는 수량 조절(+, -) 버튼이 노출된다.</p>
    </div>
  );
}
...
export default function Component() {
  return (
    <div className="bg-[#f5f5f5] relative size-full" data-name="주문오더 - 상세옵션 (다건 및 수량)">

import svgPaths from "./svg-jny2lehn8t";
import imgRectangle16 from "./088108e47778ce06fb920175df7891e3dd45f817.png";
...
function Group18() {
  return (
    <div className="absolute contents left-[77.5px] top-[655.74px]">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Roboto:Medium','Noto_Sans_KR:Medium',sans-serif] font-medium justify-center leading-[0] left-[77.5px] text-[#222] text-[14px] top-[663.74px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[normal]">장바구니에 담긴 메뉴가 없습니다.</p>
      </div>
    </div>
  );
}
...
function Group2() {
  return (
    <div className="absolute contents left-[-1px] top-[557.01px]">
      <div className="absolute bg-white border border-[#f2f4f8] border-solid h-[241.96px] left-0 rounded-tl-[4px] rounded-tr-[4px] shadow-[1px_2px_6px_1px_rgba(0,0,0,0.2)] top-[558.04px] w-[360px]" />
      <div className="absolute flex h-[30px] items-center justify-center left-[6.91px] top-[582.03px] w-[126.454px]">
        <div className="-scale-y-100 flex-none">
          <div className="h-[30px] relative w-[126.454px]">
            <img alt="" className="absolute block inset-0 max-w-none size-full" height="30" src={imgRectangle16} width="126.454" />
          </div>
        </div>
      </div>
      <div className="absolute bg-[#0f62fe] left-[138.52px] min-w-[18px] rounded-[2px] size-[20px] top-[586.03px]" data-name="화면번호">
      ...
      <div className="absolute flex items-center justify-center left-[106.84px] size-[20px] top-[587.59px]">
        <div className="flex-none rotate-180">
          <div className="bg-[#e5e8ed] relative rounded-[2px] size-[20px]" />
        </div>
      </div>
      <p className="[word-break:break-word] absolute font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-[112.84px] not-italic text-[12px] text-black top-[590.09px] whitespace-nowrap">0</p>
      <Group18 />
      <p className="[word-break:break-word] absolute font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[normal] left-[38.03px] not-italic text-[#333] text-[16px] top-[588.09px] whitespace-nowrap">장바구니</p>
      <div className="absolute h-[17.868px] left-[12.98px] top-[588.09px] w-[15.239px]" data-name="Icon">
      ...
      <div className="absolute flex h-[58.279px] items-center justify-center left-[7.27px] top-[725.22px] w-[345.033px]">
        <div className="-scale-y-100 flex-none">
      ...
      <div className="absolute bg-[#0f62fe] left-[145.89px] min-w-[18px] rounded-[2px] size-[20px] top-[698.64px]" data-name="화면번호">
        <div aria-hidden className="absolute border-2 border-[#195edf] border-solid inset-[-1px] pointer-events-none rounded-[3px]" />
        <div className="flex flex-row items-center justify-center min-w-[inherit] size-full">
          <div className="content-stretch flex items-center justify-center min-w-[inherit] px-[6px] relative size-full">
            <div className="[word-break:break-word] flex flex-[1_0_0] flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] min-w-px not-italic relative text-[12px] text-center text-white">
      ...
      <div className="absolute h-[15.471px] left-[166.53px] top-[711.07px] w-[14.366px]">
      ...
      <div className="absolute flex h-[21.534px] items-center justify-center left-[114px] top-[558.01px] w-[132px]">
        <div className="-scale-y-100 flex-none">
      ...
      <div className="absolute bg-[#0f62fe] left-[254px] min-w-[18px] rounded-[2px] size-[20px] top-[560.05px]" data-name="화면번호">
        <div aria-hidden className="absolute border-2 border-[#195edf] border-solid inset-[-1px] pointer-events-none rounded-[3px]" />
        <div className="flex flex-row items-center justify-center min-w-[inherit] size-full">
          <div className="content-stretch flex items-center justify-center min-w-[inherit] px-[6px] relative size-full">
            <div className="[word-break:break-word] flex flex-[1_0_0] flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] min-w-px not-italic relative text-[12px] text-center text-white">
...
function Desktop() {
  return (
    <div className="absolute border border-[#999] border-solid h-[800px] left-[-0.24px] overflow-clip top-0 w-[360px]" data-name="Desktop - 1">
      <Component11 />
      <div className="absolute bg-[rgba(42,42,42,0.54)] h-[800px] left-[-1px] top-[-1px] w-[360px]" />
      <Group1 />
      <Group2 />
      <div className="absolute bg-[#e5e8ed] h-[4.274px] left-[121.73px] rounded-[10px] top-[566.82px] w-[114.539px]" />
    </div>
  );
}
...
function Frame() {
  return (
    <div className="content-stretch flex gap-[6px] items-center relative shrink-0 w-full">
      ...
      <p className="[word-break:break-word] font-['Inter:Semi_Bold','Noto_Sans_KR:Bold',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[20px] text-white w-[399px]">주문오더 장바구니 - null</p>
    </div>
  );
}
...
function Component5() {
  return (
    <div className="content-center flex flex-wrap gap-y-[12px] items-center relative shrink-0 w-full" data-name="설명">
      <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[normal] min-w-px not-italic relative text-[16px] text-white">메뉴가 없을 경우 빈 메뉴와 함께 문구를 추가</p>
    </div>
  );
}
...
function Component20() {
  return (
    <div className="content-center flex flex-[1_0_0] flex-wrap gap-y-[12px] items-center min-w-px relative" data-name="설명">
      <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[normal] min-w-px not-italic relative text-[#222] text-[16px]">장바구니 내 메뉴가 모두 삭제되면 주문하기 버튼이 메뉴 보러가기 버튼으로 자동 변경되며, 클릭 시 메인페이지(메뉴 리스트)로 이동한다.</p>
    </div>
  );
}

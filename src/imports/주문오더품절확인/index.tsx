import svgPaths from "./svg-ji5ruqgkkq";
...
function Group19() {
  return (
    <div className="absolute contents left-[324.07px] top-[587.38px]">
      <div className="absolute flex h-[21.391px] items-center justify-center left-[324.07px] top-[587.38px] w-[21.799px]">
        <div className="flex-none rotate-180">
          <div className="bg-[#e5e8ed] h-[21.391px] relative rounded-[2px] w-[21.799px]" />
        </div>
      </div>
      <IcRoundPlus className="absolute left-[328.67px] size-[12.597px] top-[591.77px]" />
    </div>
  );
}
...
function Group21() {
  return (
    <div className="absolute contents left-[272.94px] top-[587.38px]">
      <div className="absolute flex h-[21.391px] items-center justify-center left-[272.94px] top-[587.38px] w-[21.799px]">
        <div className="flex-none rotate-180">
          <div className="bg-[#d72b2b] h-[21.391px] relative rounded-[2px] w-[21.799px]" />
        </div>
      </div>
      <div className="absolute flex items-center justify-center left-[274.43px] size-[18.829px] top-[588.66px]">
...
function Group20() {
  return (
    <div className="absolute contents left-[272.94px] top-[587.38px]">
      ...
      <IconsCommonsMinus className="absolute h-[14.261px] left-[277.49px] overflow-clip top-[590.94px] w-[12.716px]" />
      <Group21 />
    </div>
  );
}
...
function Group18() {
  return (
    <div className="absolute contents left-[12.98px] top-[587.38px]">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Roboto:Medium','Noto_Sans_KR:Medium',sans-serif] font-medium justify-center leading-[0] left-[12.98px] text-[#222] text-[14px] top-[598.07px] w-[95.649px]" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[normal]">메뉴 명</p>
      </div>
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Roboto:Medium','Noto_Sans_KR:Medium',sans-serif] font-medium justify-center leading-[0] left-[12.98px] text-[12px] text-black top-[665.45px] w-[95.649px]" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[normal]">39,000원</p>
      </div>
      <Group19 />
      <Group20 />
...
function Group22() {
  return (
    <div className="absolute contents left-[324.07px] top-[542.73px]">
      <div className="absolute flex h-[21.391px] items-center justify-center left-[324.07px] top-[542.73px] w-[21.799px]">
        <div className="flex-none rotate-180">
          <div className="bg-[#e5e8ed] h-[21.391px] relative rounded-[2px] w-[21.799px]" />
        </div>
      </div>
      <IcRoundPlus className="absolute left-[328.67px] size-[12.597px] top-[547.12px]" />
    </div>
  );
}
...
function Group23() {
  return (
    <div className="absolute contents left-[272.94px] top-[542.73px]">
      <div className="absolute flex h-[21.391px] items-center justify-center left-[272.94px] top-[542.73px] w-[21.799px]">
        <div className="flex-none rotate-180">
          <div className="bg-[#e5e8ed] h-[21.391px] relative rounded-[2px] w-[21.799px]" />
        </div>
      </div>
      <IconsCommonsMinus className="absolute h-[14.261px] left-[277.49px] overflow-clip top-[546.29px] w-[12.716px]" />
    </div>
  );
}
...
function Group25() {
  return (
    <div className="absolute contents left-[12.98px] top-[542.73px]">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Roboto:Medium',sans-serif] font-medium justify-center leading-[0] left-[305.23px] text-[#222] text-[14px] top-[552.1px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[normal]">2</p>
      </div>
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Roboto:Medium','Noto_Sans_KR:Medium',sans-serif] font-medium justify-center leading-[0] left-[12.98px] text-[#222] text-[14px] top-[553.42px] w-[95.649px]" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[normal]">메뉴 명</p>
      </div>
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Roboto:Medium','Noto_Sans_KR:Medium',sans-serif] font-medium justify-center leading-[0] left-[12.98px] text-[12px] text-black top-[575.15px] w-[95.649px]" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[normal]">18,000원</p>
      </div>
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Roboto:Medium','Noto_Sans_KR:Medium',sans-serif] font-medium justify-center leading-[0] left-[209.58px] text-[#0f62fe] text-[12px] top-[554.12px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
    ...
    <div className="absolute flex items-center justify-center left-[110.84px] size-[20px] top-[531.5px]">
      <div className="flex-none rotate-180">
        <div className="relative size-[20px]">
          <div className="absolute bg-[#e5e8ed] left-0 rounded-[2px] size-[20px] top-[28.62px]" />
          <div className="absolute flex items-center justify-center left-[6px] top-[31.12px]">
            <div className="flex-none rotate-180">
...
function Group2() {
  return (
    <div className="absolute contents left-[-1px] top-[458.5px]">
      ...
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Roboto:Medium',sans-serif] font-medium justify-center leading-[0] left-[305.23px] text-[#222] text-[14px] top-[596.71px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[normal]">1</p>
      </div>
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Roboto:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal justify-center leading-[0] left-[12.98px] text-[#999] text-[10px] top-[617.22px] w-[205.62px]" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[normal]">메뉴 옵션 명 (500원) X 2</p>
      </div>
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Roboto:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal justify-center leading-[0] left-[12.98px] text-[#999] text-[10px] top-[631.75px] w-[205.62px]" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[normal]">메뉴 옵션 명 (1000원)</p>
      </div>
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Roboto:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal justify-center leading-[0] left-[12.98px] text-[#999] text-[10px] top-[645.95px] w-[205.62px]" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[normal]">메뉴 옵션 명</p>
      </div>
      <Group18 />
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Roboto:Medium','Noto_Sans_KR:Medium',sans-serif] font-medium justify-center leading-[0] left-[209.58px] text-[#0f62fe] text-[12px] top-[598.07px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[normal]">41,000원</p>
      </div>
      <Group25 />
      <p className="[word-break:break-word] absolute font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[normal] left-[38.03px] not-italic text-[#333] text-[16px] top-[503.93px] whitespace-nowrap">장바구니</p>
      <div className="absolute h-[17.868px] left-[12.98px] top-[503.93px] w-[15.239px]" data-name="Icon">
...
function Group24() {
  return (
    <div className="absolute contents left-[46.68px] top-[299.88px]">
      ...
      <div className="-translate-x-1/2 [word-break:break-word] absolute font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[0] left-[186.29px] not-italic text-[#333] text-[14px] text-center top-[358.99px] w-[209.49px]">
        <p className="leading-[normal] mb-0">주문할 수 없는 메뉴가 있습니다</p>
        <p className="leading-[normal]">품절된 메뉴를 확인해 주세요.</p>
      </div>
      <Frame5 />
...
function Frame() {
  return (
    <div className="content-stretch flex gap-[6px] items-center relative shrink-0 w-full">
      ...
      <p className="[word-break:break-word] font-['Inter:Semi_Bold','Noto_Sans_KR:Bold',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[20px] text-white w-[399px]">주문오더 장바구니 - 품절확인</p>
    </div>
  );
}
...
function Component5() {
  return (
    <div className="content-center flex flex-wrap gap-y-[12px] items-center relative shrink-0 w-full" data-name="설명">
      <p className="[word-break:break-word] font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[16px] text-white whitespace-nowrap">상단에 품절 안내 모달을 추가</p>
    </div>
  );
}
...
function Component12() {
  return (
    <div className="content-center flex flex-[1_0_0] flex-wrap gap-y-[12px] items-center min-w-px relative" data-name="설명">
      <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[normal] min-w-px not-italic relative text-[#222] text-[16px]">주문하기시점 서버 응답에서 선택한 메뉴 중 1개 이상의 품절항목이 포함된 경우 노출한다.</p>
    </div>
  );
}
...
export default function Component() {
  return (
    <div className="bg-white relative size-full" data-name="주문오더 - 품절확인">

import svgPaths from "./svg-qm447an83t";
type DisplayProps = {
  className?: string;
  color?: "white";
  display?: "web";
...
function Group16() {
  return (
    <div className="absolute contents left-[9.71px] top-[540px]">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Roboto:Medium','Noto_Sans_KR:Medium',sans-serif] font-medium justify-center leading-[0] left-[9.71px] text-[#222] text-[16px] top-[549.5px] w-[96px]" style={{ fontVariationSettings: '"wdth" 100' }}>
      ...
      <div className="overflow-clip relative shrink-0 size-[20px]" data-name="Icon">
        <div className="absolute inset-[8.33%_12.5%]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" height="16.6667" preserveAspectRatio="none" viewBox="0 0 15 16.6667" width="15">
            <path d={svgPaths.p24b4e5b2} fill="#001D6C" id="Vector" />
          </svg>
        </div>
      </div>
      <div className="[word-break:break-word] flex flex-col font-['Roboto:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[14px] text-black tracking-[0.1px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
...
function IPhone() {
  return (
    <div className="bg-white h-[800px] overflow-clip relative shrink-0 w-[360px]" data-name="iPhone 17 - 1">
      ...
      <div className="absolute bg-white border border-[#f2f4f8] border-solid h-[295.879px] left-[0.39px] rounded-tl-[4px] rounded-tr-[4px] shadow-[1px_2px_6px_1px_rgba(0,0,0,0.2)] top-[504.12px] w-[360px]" />
      <Frame4 />
      <Group16 />
      <div className="absolute bg-[#e5e8ed] h-[4.274px] left-[123.13px] rounded-[10px] top-[513.08px] w-[114.539px]" />
      <div className="absolute h-[48px] left-[10px] top-[570.11px]" data-name="Button - elevated">
        <div className="flex flex-row items-center justify-center size-full">
      ...
      <div className="absolute h-[48px] left-[88px] top-[570.11px]" data-name="Button - elevated">
        <div className="flex flex-row items-center justify-center size-full">
          <div className="content-stretch flex items-center justify-center relative size-full">
            <Content1 />
          </div>
      ...
      <div className="absolute h-[48px] left-[192px] top-[570.11px]" data-name="Button - elevated">
        <div className="flex flex-row items-center justify-center size-full">
          <div className="content-stretch flex items-center justify-center relative size-full">
            <Content2 />
          </div>
      ...
      <div className="absolute h-[48px] left-[270px] top-[570.11px]" data-name="Button - elevated">
        <div className="flex flex-row items-center justify-center size-full">
          <div className="content-stretch flex items-center justify-center relative size-full">
            <Content3 />
          </div>
      ...
      <div className="absolute h-[48px] left-[10px] top-[618.11px]" data-name="Button - elevated">
        <div className="flex flex-row items-center justify-center size-full">
          <div className="content-stretch flex items-center justify-center relative size-full">
            <Content4 />
          </div>
      ...
      <div className="absolute h-[48px] left-[114px] top-[618.11px]" data-name="Button - elevated">
        <div className="flex flex-row items-center justify-center size-full">
          <div className="content-stretch flex items-center justify-center relative size-full">
            <Content5 />
          </div>
      ...
      <div className="absolute h-[48px] left-[205px] top-[618.11px]" data-name="Button - elevated">
        <div className="flex flex-row items-center justify-center size-full">
          <div className="content-stretch flex items-center justify-center relative size-full">
            <Content6 />
          </div>
      ...
      <div className="absolute h-[48px] left-[10px] top-[666.11px]" data-name="Button - elevated">
        <div className="flex flex-row items-center justify-center size-full">
          <div className="content-stretch flex items-center justify-center relative size-full">
            <Content7 />
          </div>
      ...
      <div className="absolute h-[48px] left-[127px] top-[666.11px]" data-name="Button - elevated">
        <div className="flex flex-row items-center justify-center size-full">
          <div className="content-stretch flex items-center justify-center relative size-full">
            <Content8 />
          </div>
      ...
      <div className="absolute h-[48px] left-[244px] top-[666.11px]" data-name="Button - elevated">
        <div className="flex flex-row items-center justify-center size-full">
          <div className="content-stretch flex items-center justify-center relative size-full">
            <Content9 />
          </div>
...
function Component3() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start py-[10px] relative shrink-0 w-full" data-name="타이틀">
      <Frame />
      <p className="[word-break:break-word] font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[16px] text-white w-[432px]">메인페이지</p>
    </div>
  );
}
...
export default function Component() {
  return (
    <div className="bg-white relative size-full" data-name="주문오더 - 직원호출">

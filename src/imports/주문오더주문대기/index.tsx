import svgPaths from "./svg-7pqac3d90c";
import imgRectangle16 from "./96149beaf032ce77dd0025a397a5da1bf97c5520.png";
type DisplayProps = {
  className?: string;
  color?: "white";
  display?: "web";
...
function EosIconsLoading({ className }: { className?: string }) {
  return (
    <div className={className || "relative size-[24px]"} data-name="eos-icons:loading">
      <div className="absolute inset-[8.33%]" data-name="Vector">
        <svg className="absolute block inset-0 size-full" fill="none" height="20" preserveAspectRatio="none" viewBox="0 0 20 20" width="20">
          <path d={svgPaths.p36cc900} fill="black" id="Vector" opacity="0.5" />
        </svg>
      </div>
      <div className="absolute bottom-1/2 left-1/2 right-[8.33%] top-[8.33%]" data-name="Vector">
        <svg className="absolute block inset-0 size-full" fill="none" height="10" preserveAspectRatio="none" viewBox="0 0 10 10" width="10">
          <path d={svgPaths.pc027580} fill="black" id="Vector" />
        </svg>
      </div>
    </div>
  );
...
function Group18() {
  return (
    <div className="absolute contents left-[41.38px] top-[408.8px]">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Roboto:Medium','Noto_Sans_KR:Medium',sans-serif] font-medium justify-center leading-[0] left-[41.38px] text-[#222] text-[14px] top-[416.8px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[normal]">잠시만 기다려주세요, 주문 접수가 진행 중입니다.</p>
      </div>
    </div>
  );
}
...
function Group19() {
  return (
    <div className="absolute contents left-[123.38px] top-[374.2px]">
      <p className="[word-break:break-word] absolute font-['Inter:Semi_Bold','Noto_Sans_KR:Bold',sans-serif] font-semibold leading-[normal] left-[124.38px] not-italic text-[#333] text-[18px] top-[377.2px] whitespace-nowrap">주문 처리중</p>
      <EosIconsLoading className="absolute left-[217.38px] size-[24px] top-[375.2px]" />
    </div>
  );
}
...
function IPhone() {
  return (
    <div className="bg-white flex-[1_0_0] h-[800px] min-w-px overflow-clip relative" data-name="iPhone 17 - 1">
      ...
      <Desktop />
      <Frame6 />
      <div className="absolute flex h-[73.5px] items-center justify-center left-[35px] top-[370px] w-[288.173px]">
        <div className="-scale-y-100 flex-none">
          <div className="h-[73.5px] relative w-[288.173px]">
            <img alt="" className="absolute block inset-0 max-w-none size-full" height="73.5" src={imgRectangle16} width="288.173" />
          </div>
        </div>
      </div>
      <div className="absolute bg-[#0f62fe] left-[37.5px] min-w-[18px] rounded-[2px] size-[20px] top-[343.5px]" data-name="화면번호">
...
function Frame() {
  return (
    <div className="content-stretch flex gap-[6px] items-center relative shrink-0 w-full">
      ...
      <p className="[word-break:break-word] font-['Inter:Semi_Bold','Noto_Sans_KR:Bold',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[20px] text-white w-[399px]">주문오더 장바구니 - 주문처리</p>
    </div>
  );
}
...
function Component3() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start py-[10px] relative shrink-0 w-full" data-name="타이틀">
      <Frame />
      <p className="[word-break:break-word] font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[16px] text-white w-[432px]">주문처리 페이지</p>
    </div>
  );
}
...
function Component5() {
  return (
    <div className="content-center flex flex-wrap gap-y-[12px] items-center relative shrink-0 w-full" data-name="설명">
      <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[normal] min-w-px not-italic relative text-[16px] text-white">주문 후 결과를 받기 전까지 로딩처리</p>
    </div>
  );
}
    ...
    <div className="relative shrink-0 w-full" data-name="컨텐츠-번호">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[10px] items-center px-[20px] relative size-full">
          <Component10 />
          <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Semi_Bold','Noto_Sans_KR:Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#666] text-[18px]">주문 처리 딜레이</p>
        </div>
      </div>
    </div>
  );
...
function Component13() {
  return (
    <div className="content-center flex flex-[1_0_0] flex-wrap gap-y-[12px] items-center min-w-px relative" data-name="설명">
      <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[normal] min-w-px not-italic relative text-[#222] text-[16px]">주문하기 클릭 시 서버 응답 결과, 네트워크 상태, 처리 지연 여부와 관계없이 무조건 전체 화면 로딩(대기) UI로 즉시 전환되어 화면을 차단한다.</p>
    </div>
  );
}
...
export default function Component() {
  return (
    <div className="bg-white relative size-full" data-name="주문오더 - 주문대기">

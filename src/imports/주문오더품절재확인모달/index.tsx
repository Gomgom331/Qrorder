import svgPaths from "./svg-emi89va81e";
import imgRectangle16 from "./b1258270e8010fb1be7ba92e91e3d66823fb9457.png";
type DisplayProps = {
  className?: string;
  color?: "white";
  display?: "web";
...
function Group20() {
  return (
    <div className="absolute contents left-[324.07px] top-[578.91px]">
      <div className="absolute flex h-[21.391px] items-center justify-center left-[324.07px] top-[578.91px] w-[21.799px]">
        <div className="flex-none rotate-180">
          <div className="bg-[#d72b2b] h-[21.391px] relative rounded-[2px] w-[21.799px]" />
        </div>
      </div>
      <div className="absolute flex items-center justify-center left-[325.55px] size-[18.829px] top-[580.19px]">
...
function Group19() {
  return (
    <div className="absolute contents left-[324.07px] top-[578.91px]">
      ...
      <IconsCommonsMinus className="absolute h-[14.261px] left-[328.61px] overflow-clip top-[582.47px] w-[12.716px]" />
      <Group20 />
    </div>
  );
}
...
function Group18() {
  return (
    <div className="absolute contents left-[12.98px] top-[578.91px]">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Roboto:Medium','Noto_Sans_KR:Medium',sans-serif] font-medium justify-center leading-[0] left-[12.98px] text-[#222] text-[14px] top-[589.6px] w-[95.649px]" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="[text-decoration-skip-ink:none] [text-underline-position:from-font] decoration-from-font decoration-solid leading-[normal] line-through">메뉴 명</p>
      </div>
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Roboto:Medium','Noto_Sans_KR:Medium',sans-serif] font-medium justify-center leading-[0] left-[12.98px] text-[12px] text-black top-[671.03px] w-[95.649px]" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[normal]">39,000원</p>
      </div>
      <Group19 />
    </div>
...
function Group21() {
  return (
    <div className="absolute contents left-[324.07px] top-[535.19px]">
      <div className="absolute flex h-[21.391px] items-center justify-center left-[324.07px] top-[535.19px] w-[21.799px]">
        <div className="flex-none rotate-180">
          <div className="bg-[#e5e8ed] h-[21.391px] relative rounded-[2px] w-[21.799px]" />
        </div>
      </div>
      <IcRoundPlus className="absolute left-[328.67px] size-[12.597px] top-[539.59px]" />
    </div>
  );
}
...
function Group22() {
  return (
    <div className="absolute contents left-[272.94px] top-[535.19px]">
      <div className="absolute flex h-[21.391px] items-center justify-center left-[272.94px] top-[535.19px] w-[21.799px]">
        <div className="flex-none rotate-180">
          <div className="bg-[#e5e8ed] h-[21.391px] relative rounded-[2px] w-[21.799px]" />
        </div>
      </div>
      <IconsCommonsMinus className="absolute h-[14.261px] left-[277.49px] overflow-clip top-[538.76px] w-[12.716px]" />
    </div>
  );
}
...
function Group24() {
  return (
    <div className="absolute contents left-[12.98px] top-[535.19px]">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Roboto:Medium',sans-serif] font-medium justify-center leading-[0] left-[305.23px] text-[#222] text-[14px] top-[544.56px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[normal]">2</p>
      </div>
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Roboto:Medium','Noto_Sans_KR:Medium',sans-serif] font-medium justify-center leading-[0] left-[12.98px] text-[#222] text-[14px] top-[545.89px] w-[95.649px]" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[normal]">메뉴 명</p>
      </div>
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Roboto:Medium','Noto_Sans_KR:Medium',sans-serif] font-medium justify-center leading-[0] left-[12.98px] text-[12px] text-black top-[567.61px] w-[95.649px]" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[normal]">18,000원</p>
      </div>
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Roboto:Medium','Noto_Sans_KR:Medium',sans-serif] font-medium justify-center leading-[0] left-[209.58px] text-[#0f62fe] text-[12px] top-[546.59px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
    ...
    <div className="absolute flex items-center justify-center left-[110.84px] size-[20px] top-[531.5px]">
      <div className="flex-none rotate-180">
        <div className="relative size-[20px]">
          <div className="absolute bg-[#e5e8ed] left-0 rounded-[2px] size-[20px] top-[36.16px]" />
          <div className="absolute flex items-center justify-center left-[6px] top-[38.66px]">
            <div className="flex-none rotate-180">
...
function Group2() {
  return (
    <div className="absolute contents left-[-1px] top-[458.5px]">
      <div className="absolute bg-white border border-[#f2f4f8] border-solid h-[340.5px] left-0 rounded-tl-[4px] rounded-tr-[4px] shadow-[1px_2px_6px_1px_rgba(0,0,0,0.2)] top-[459.5px] w-[360px]" />
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Roboto:Bold','Noto_Sans_KR:Bold',sans-serif] font-bold justify-center leading-[0] left-[290.2px] text-[#0f62fe] text-[14px] top-[708.56px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[normal]">77,000원</p>
      </div>
      ...
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Roboto:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal justify-center leading-[0] left-[12.98px] text-[#999] text-[10px] top-[608.75px] w-[205.62px]" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="[text-decoration-skip-ink:none] [text-underline-position:from-font] decoration-from-font decoration-solid leading-[normal] line-through">메뉴 옵션 명 (500원) X 2</p>
      </div>
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Roboto:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal justify-center leading-[0] left-[12.98px] text-[#999] text-[10px] top-[623.28px] w-[205.62px]" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="[text-decoration-skip-ink:none] [text-underline-position:from-font] decoration-from-font decoration-solid leading-[normal] line-through">메뉴 옵션 명 (1000원)</p>
      </div>
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Roboto:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal justify-center leading-[0] left-[12.98px] text-[#999] text-[10px] top-[637.48px] w-[205.62px]" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="[text-decoration-skip-ink:none] [text-underline-position:from-font] decoration-from-font decoration-solid leading-[normal] line-through">메뉴 옵션 명</p>
      </div>
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Roboto:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal justify-center leading-[0] left-[12.98px] text-[#d72b2b] text-[10px] top-[651.68px] w-[205.62px]" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[normal]">현재 품절된 메뉴입니다</p>
      </div>
      <Group18 />
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Roboto:Medium','Noto_Sans_KR:Medium',sans-serif] font-medium justify-center leading-[0] left-[209.58px] text-[#0f62fe] text-[12px] top-[589.6px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[normal]">41,000원</p>
      </div>
      <Group24 />
      <p className="[word-break:break-word] absolute font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[normal] left-[38.03px] not-italic text-[#333] text-[16px] top-[496.39px] whitespace-nowrap">장바구니</p>
      <div className="absolute h-[17.868px] left-[12.98px] top-[496.39px] w-[15.239px]" data-name="Icon">
...
function Desktop() {
  return (
    <div className="absolute border border-[#999] border-solid h-[800px] left-[-0.24px] overflow-clip top-0 w-[360px]" data-name="Desktop - 1">
      ...
      <Group1 />
      <Group2 />
      <div className="absolute bg-[#e5e8ed] h-[4.274px] left-[121.73px] rounded-[10px] top-[473.43px] w-[114.539px]" />
    </div>
  );
}
...
function Frame6() {
  return (
    <div className="absolute content-stretch flex items-center left-[10.38px] top-[730.11px] w-[339px]">
      <div className="bg-[#c1c7cd] flex-[1_0_0] h-[48px] min-w-px relative" data-name="button">
        <div aria-hidden className="absolute border-2 border-[#c1c7cd] border-solid inset-0 pointer-events-none" />
        <div className="flex flex-row items-center justify-center size-full">
          <div className="content-stretch flex items-center justify-center px-[12px] py-[16px] relative size-full">
            <TextContainer12 />
          </div>
...
function Frame5() {
  return (
    <div className="absolute content-stretch flex items-center left-[146.8px] top-[410.11px]">
      <div className="bg-[#e5e8ed] h-[31px] relative shrink-0 w-[71px]" data-name="button">
        <div aria-hidden className="absolute border border-[#e5e8ed] border-solid inset-0 pointer-events-none" />
        <div className="flex flex-row items-center justify-center size-full">
          <div className="content-stretch flex items-center justify-center px-[12px] py-[16px] relative size-full">
...
function Group23() {
  return (
    <div className="absolute contents left-[46.68px] top-[299.88px]">
      <div className="absolute bg-white border border-[#f2f4f8] border-solid h-[149.486px] left-[51.81px] shadow-[1px_2px_6px_1px_rgba(0,0,0,0.2)] top-[307.46px] w-[260.976px]" />
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[normal] left-[186.29px] not-italic text-[#333] text-[14px] text-center top-[358.99px] w-[209.49px]">
        품절된 메뉴를 삭제한 후<br aria-hidden />
        다시 주문해 주세요.
      </p>
      <Frame5 />
      <IconCommonsAdd className="absolute flex items-center justify-center left-[280.46px] size-[26.593px] top-[311.11px]" />
      <div className="absolute flex h-[164.229px] items-center justify-center left-[46.68px] top-[299.88px] w-[271.779px]">
        <div className="-scale-y-100 flex-none">
          <div className="h-[164.229px] relative w-[271.779px]">
            <img alt="" className="absolute block inset-0 max-w-none size-full" height="164.229" src={imgRectangle16} width="271.779" />
          </div>
        </div>
      </div>
      <div className="absolute bg-[#0f62fe] left-[322px] min-w-[18px] rounded-[2px] size-[20px] top-[302.56px]" data-name="화면번호">
...
function IPhone() {
  return (
    <div className="bg-white flex-[1_0_0] h-[800px] min-w-px overflow-clip relative" data-name="iPhone 17 - 1">
      ...
      <Desktop />
      <Frame6 />
      <div className="absolute bg-[rgba(42,42,42,0.54)] h-[800px] left-0 top-0 w-[359.758px]" />
      <Group23 />
    </div>
  );
}
...
function Frame() {
  return (
    <div className="content-stretch flex gap-[6px] items-center relative shrink-0 w-full">
      ...
      <p className="[word-break:break-word] font-['Inter:Semi_Bold','Noto_Sans_KR:Bold',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[20px] text-white w-[399px]">주문오더 장바구니 - 품절재확인</p>
    </div>
  );
}
...
function Component3() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start py-[10px] relative shrink-0 w-full" data-name="타이틀">
      <Frame />
      <p className="[word-break:break-word] font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[16px] text-white w-[432px]">주문하기 재고/품절확인</p>
    </div>
  );
}
...
function Component5() {
  return (
    <div className="content-center flex flex-wrap gap-y-[12px] items-center relative shrink-0 w-full" data-name="설명">
      <p className="[word-break:break-word] font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[16px] text-white whitespace-nowrap">주문하기 버튼을 비활성화 하지만 만약 눌렸을 경우의 확인모달</p>
    </div>
  );
}
    ...
    <div className="relative shrink-0 w-full" data-name="컨텐츠-번호">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[10px] items-center px-[20px] relative size-full">
          <Component10 />
          <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Semi_Bold','Noto_Sans_KR:Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#666] text-[18px]">품절 안내 모달</p>
        </div>
      </div>
    </div>
  );
...
function Component12() {
  return (
    <div className="content-center flex flex-[1_0_0] flex-wrap gap-y-[12px] items-center min-w-px relative" data-name="설명">
      <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[normal] min-w-px not-italic relative text-[#222] text-[16px]">주문 리스트에 품절 메뉴가 1개 이상 포함된 경우 주문하기 버튼을 눌렀을시 재확인 모달</p>
    </div>
  );
}
...
export default function Component() {
  return (
    <div className="bg-white relative size-full" data-name="주문오더 - 품절 재확인 모달">

...
import svgPaths from "./svg-poa6xhmitd";
...
type Desktop1Text1Props = {
  text: string;
};

function Desktop1Text1({ text }: Desktop1Text1Props) {
  return (
...
function Text({ text, additionalClassNames = "" }: TextProps) {
  return <Text1 text={text} additionalClassNames={clsx("absolute bg-[#0f62fe] h-[20px] min-w-[18px] rounded-[2px] top-[513.75px] w-[22px]", additionalClassNames)} />;
}
...
function Desktop1Text({ text, additionalClassNames = "" }: Desktop1TextProps) {
  return <Text1 text={text} additionalClassNames={clsx("absolute bg-[#0f62fe] min-w-[18px] rounded-[2px] size-[20px]", additionalClassNames)} />;
}

function Frame4Helper() {
  return (
    <div style={{ fontVariationSettings: "'wdth' 100" }} className="flex flex-col font-['Roboto:Regular',sans-serif] font-normal justify-center relative shrink-0 text-[#999]">
...
function Frame4Text({ text, additionalClassNames = "" }: Frame4TextProps) {
  return (
...
function Helper({ additionalClassNames = "" }: HelperProps) {
  return (
    <div className={clsx("grid-cols-[max-content] grid-rows-[max-content] inline-grid place-items-start relative", additionalClassNames)}>
      <div className="bg-[#e5e8ed] col-1 h-[48px] ml-0 mt-0 row-1 w-[52.295px]" />
...
function TextContainerText({ text, additionalClassNames = "" }: TextContainerTextProps) {
  return (
...
function Row() {
  return (
    <div className="bg-[rgba(255,255,255,0)] content-stretch flex h-[44px] items-end overflow-clip relative shrink-0 w-full">
...
function Cell4() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col h-full items-start justify-center min-h-px min-w-px relative">
      ...
      <div className="content-stretch flex flex-col items-start justify-center overflow-clip pb-[17px] pt-[12px] px-[12px] relative shrink-0 w-[160px]">
...
export default function Component() {
  return (
    <div className="bg-[#f1f1f1] relative size-full" data-name="공통코드 관리">
      <div className="content-stretch flex items-start relative size-full">
        <div className="bg-white h-[1024px] relative shrink-0 w-[1440px]" data-name="Desktop - 1">
          <div className="overflow-clip relative rounded-[inherit] size-full">
            ...
            <div className="absolute bg-white h-[288px] left-[56.5px] top-[216px] w-[1351px]" data-name="Table">
            ...
            <div className="absolute bg-white left-[56.5px] top-[570px] w-[1351px]" data-name="Table">
            ...
            <div className="absolute content-stretch flex gap-[8px] h-[48px] items-center justify-center left-[56.5px] py-[16px] top-[522px]" data-name="tab">
              <TextContainerText text="공통코드 상세 목록" additionalClassNames="gap-[4px]" />
            </div>
            <div className="absolute content-stretch flex gap-[12px] items-center left-[948.91px] top-[513px]">
              <div className="flex items-center justify-center leading-[0] relative shrink-0">
                <div className="flex-none rotate-180">
                  <Helper />
                </div>
              </div>
              <Helper additionalClassNames="leading-[0] shrink-0" />
            ...
            <Text text="8" additionalClassNames="left-[912.5px]" />
            <div className="absolute border-2 border-[#0f62fe] border-dashed h-[63px] left-[941.5px] top-[504.75px] w-[473.488px]" />
            <Text text="9" additionalClassNames="left-[883px]" />
            <div className="absolute bg-[#0f62fe] h-[20px] left-[853.5px] min-w-[18px] rounded-[2px] top-[513.75px] w-[22px]" data-name="화면번호">
              <div aria-hidden="true" className="absolute border-2 border-[#195edf] border-solid inset-[-1px] pointer-events-none rounded-[3px]" />
              <Desktop1Text1 text="10" />
            </div>
            <Desktop1Text text="1" additionalClassNames="left-[1008.5px] top-[69px]" />
            ...
            <Desktop1Text text="4" additionalClassNames="left-[1121.5px] top-[69px]" />
            <div className="absolute border-2 border-[#0f62fe] border-dashed h-[62.927px] left-[1121.5px] top-[94.34px] w-[93px]" />
            <Desktop1Text text="6" additionalClassNames="left-[1219.5px] top-[69px]" />
            <div className="absolute border-2 border-[#0f62fe] border-dashed h-[62.927px] left-[1219.5px] top-[94.34px] w-[93px]" />
            <Desktop1Text text="3" additionalClassNames="left-[30.5px] top-[172px]" />
            <Desktop1Text text="5" additionalClassNames="left-[1300.66px] top-[239px]" />
            ...
            <div className="absolute content-stretch flex gap-[6px] items-center leading-[0] left-[56.5px] text-[14px] top-[60.34px] whitespace-nowrap">
              <Frame4Text text="시스템" additionalClassNames="font-['Roboto:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal text-[#999]" />
              <Frame4Helper />
              <Frame4Text text="시스템 관리" additionalClassNames="font-['Roboto:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal text-[#999]" />
              <Frame4Helper />
              <Frame4Text text="공통코드 마스터(메뉴 코드 ← 관리자 백오피스에만/회사프로그램에도 넣음)" additionalClassNames="font-['Roboto:Medium','Noto_Sans_KR:Medium','Noto_Sans:Medium',sans-serif] font-medium text-[#222]" />
            </div>
            <div className="absolute h-[164.188px] left-[11.45px] top-[477.51px] w-[38.311px]">
              <div className="absolute inset-[-0.61%_-2.61%_-4.49%_-2.61%]">
                <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 40.3106 172.552">
                  <path d={svgPaths.pbe933c0} fill="var(--stroke-0, #0F62FE)" id="Vector 4" />
                </svg>
              </div>
            </div>
            <Desktop1Text text="7" additionalClassNames="left-[30.6px] top-[470px]" />
          </div>
              ...
              <div className="content-stretch flex flex-col gap-[8px] items-start justify-center min-h-[inherit] p-[20px] relative w-full">
                <div className="content-stretch flex flex-col gap-[10px] items-start py-[10px] relative shrink-0 w-full" data-name="타이틀">
                  <div className="content-stretch flex gap-[6px] items-center relative shrink-0 w-full">
                    ...
                    <p className="flex-[1_0_0] font-['Inter:Semi_Bold','Noto_Sans_KR:Bold',sans-serif] font-semibold leading-[normal] min-h-px min-w-px not-italic relative text-[20px] text-white">공통코드 마스터</p>
                  </div>
                  <p className="font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[16px] text-white w-full">시스템/시스템관리/공통코드 마스터</p>
                </div>
          ...
          <div className="bg-white content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="화면구성-컨텐츠">
            ...
            <div className="content-stretch flex flex-col gap-[10px] items-start justify-center py-[10px] relative shrink-0 w-full" data-name="컨텐츠-박스">
              ...
              <div className="relative shrink-0 w-full" data-name="컨텐츠-내용">
                <div className="flex flex-row items-center size-full">
                  <div className="content-stretch flex items-center px-[20px] relative w-full">
                    <Text3 text="검색어는 searchKeyword 파라미터로 송수신 하여야 하며, 마스터코드 데이터에만 반영된다." />
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="relative shrink-0 w-full" data-name="컨텐츠-번호">
                <div className="flex flex-row items-center size-full">
                  <div className="content-stretch flex gap-[10px] items-center px-[20px] relative w-full">
                    ...
                    <p className="flex-[1_0_0] font-['Inter:Semi_Bold','Noto_Sans_KR:Bold',sans-serif] font-semibold leading-[normal] min-h-px min-w-px not-italic relative text-[#666] text-[18px]">공통코드마스터</p>
                  </div>
                </div>
              </div>
              <div className="relative shrink-0 w-full" data-name="컨텐츠-내용">
                  ...
                  <div className="content-stretch flex items-center px-[20px] relative w-full">
                    <div className="content-center flex flex-[1_0_0] flex-wrap gap-y-[12px] items-center min-h-px min-w-px relative" data-name="설명">
                      <p className="flex-[1_0_0] font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[normal] min-h-px min-w-px not-italic relative text-[#222] text-[16px]">
                        마스터코드는 행추가, 삭제가 아닌 모달 팝업으로 데이터의 CRU가 이루어진다.
                        <br aria-hidden="true" />
                        신규 버튼 클릭 시 마스터코드 데이터를 등록 할 수 있는 신규 팝업이 등장한다.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div className="bg-white content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="화면구성-컨텐츠">
            ...
            <div className="content-stretch flex flex-col gap-[10px] items-start justify-center py-[10px] relative shrink-0 w-full" data-name="컨텐츠-박스">
              ...
              <div className="relative shrink-0 w-full" data-name="컨텐츠-내용">
                <div className="flex flex-row items-center size-full">
                  <div className="content-stretch flex items-center px-[20px] relative w-full">
                    <Text3 text="생성된 마스터코드 데이터 리스트 우측 수정 아이콘을 누를시 수정 팝업이 등장한다." />
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="화면구성-컨텐츠">
            ...
            <div className="content-stretch flex flex-col gap-[10px] items-start justify-center py-[10px] relative shrink-0 w-full" data-name="컨텐츠-박스">
              ...
              <div className="relative shrink-0 w-full" data-name="컨텐츠-내용">
                <div className="flex flex-row items-center size-full">
                  <div className="content-stretch flex items-center px-[20px] relative w-full">
                    <Text3 text="체크박스 선택 후 삭제 버튼 클릭 시, 선택한 마스터코드 데이터에 대한 삭제 진행 전, Confirm 팝업이 등장한다." />
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="relative shrink-0 w-full" data-name="컨텐츠-번호">
                <div className="flex flex-row items-center size-full">
                  <div className="content-stretch flex gap-[10px] items-center px-[20px] relative w-full">
                    ...
                    <p className="flex-[1_0_0] font-['Inter:Semi_Bold','Noto_Sans_KR:Bold',sans-serif] font-semibold leading-[normal] min-h-px min-w-px not-italic relative text-[#666] text-[18px]">공통코드상세 데이터 조회</p>
                  </div>
                </div>
              </div>
              <div className="relative shrink-0 w-full" data-name="컨텐츠-내용">
                <div className="flex flex-row items-center size-full">
                  <div className="content-stretch flex items-center px-[20px] relative w-full">
                    <Text3 text="생성된 마스터코드 데이터를 클릭 시, 상세코드 데이터 조회 기능이 작동한다. 8. 상세코드의 경우, 마스터코드 데이터를 선택 한 이후부터 순번이동, 행추가, 행삭제, 저장 등의 기능을 사용 할 수 있다." />
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="relative shrink-0 w-full" data-name="컨텐츠-번호">
                <div className="flex flex-row items-center size-full">
                  <div className="content-stretch flex gap-[10px] items-center px-[20px] relative w-full">
                    ...
                    <p className="flex-[1_0_0] font-['Inter:Semi_Bold','Noto_Sans_KR:Bold',sans-serif] font-semibold leading-[normal] min-h-px min-w-px not-italic relative text-[#666] text-[18px]">공통코드상세</p>
                  </div>
                </div>
              </div>
              <div className="relative shrink-0 w-full" data-name="컨텐츠-내용">
                <div className="flex flex-row items-center size-full">
                  <div className="content-stretch flex items-center px-[20px] relative w-full">
                    <Text3 text="상세코드의 경우, 마스터코드 데이터를 선택 한 이후부터 순번이동, 행추가, 행삭제, 저장 등의 기능을 사용 할 수 있다." />
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="relative shrink-0 w-full" data-name="컨텐츠-번호">
                <div className="flex flex-row items-center size-full">
                  <div className="content-stretch flex gap-[10px] items-center px-[20px] relative w-full">
                    ...
                    <p className="flex-[1_0_0] font-['Inter:Semi_Bold','Noto_Sans_KR:Bold',sans-serif] font-semibold leading-[normal] min-h-px min-w-px not-italic relative text-[#666] text-[18px]">데이터 행추가</p>
                  </div>
                </div>
              </div>
              <div className="relative shrink-0 w-full" data-name="컨텐츠-내용">
              ...
              <div className="relative shrink-0 w-full" data-name="컨텐츠-번호">
                <div className="flex flex-row items-center size-full">
                  <div className="content-stretch flex gap-[10px] items-center px-[20px] relative w-full">
                    ...
                    <p className="flex-[1_0_0] font-['Inter:Semi_Bold','Noto_Sans_KR:Bold',sans-serif] font-semibold leading-[normal] min-h-px min-w-px not-italic relative text-[#666] text-[18px]">순번 이동</p>
                  </div>
                </div>
              </div>
              <div className="relative shrink-0 w-full" data-name="컨텐츠-내용">
                <div className="flex flex-row items-center size-full">
                  <div className="content-stretch flex items-center px-[20px] relative w-full">
                    <Text3 text="생성된 데이터의 순번 이동 시, 실제 위치가 변경되고 순번 데이터도 수정이 되어야 한다." />
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="relative shrink-0 w-full" data-name="컨텐츠-번호">
                <div className="flex flex-row items-center size-full">
                  <div className="content-stretch flex gap-[10px] items-center px-[20px] relative w-full">
                    ...
                    <p className="flex-[1_0_0] font-['Inter:Semi_Bold','Noto_Sans_KR:Bold',sans-serif] font-semibold leading-[normal] min-h-px min-w-px not-italic relative text-[#666] text-[18px]">상세 저장</p>
                  </div>
                </div>
              </div>
              <div className="relative shrink-0 w-full" data-name="컨텐츠-내용">
                <div className="flex flex-row items-center size-full">
                  <div className="content-stretch flex items-center px-[20px] relative w-full">
                    <Text3 text="생성, 삭제, 수정 된 데이터의 경우 각각 newItems, delItems, updateItems 배열에 담아두어야 한다." />
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="화면구성-컨텐츠">
            ...
            <div className="content-stretch flex flex-col gap-[10px] items-start justify-center py-[10px] relative shrink-0 w-full" data-name="컨텐츠-박스">
              ...
              <div className="relative shrink-0 w-full" data-name="컨텐츠-내용">
                <div className="flex flex-row items-center size-full">
                  <div className="content-stretch flex items-center px-[20px] relative w-full">
                    <Text3 text="데이터 생성, 삭제, 수정 후 저장 할 경우 상기 3개의 배열을 모두 전송해야한다." />
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="화면구성-컨텐츠">
            ...
            <div className="content-stretch flex flex-col gap-[10px] items-start justify-center py-[10px] relative shrink-0 w-full" data-name="컨텐츠-박스">
              <div className="relative shrink-0 w-full" data-name="컨텐츠-번호">
                <div className="flex flex-row items-center size-full">
                  <div className="content-stretch flex gap-[10px] items-center px-[20px] relative w-full">
                    <Text2 text="13" additionalClassNames="h-[18px] w-[26px]" />

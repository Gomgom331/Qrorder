import svgPaths from "./svg-f01toa9swl";
import imgRectangle57 from "./3b834ab54ee01b494b5c945d98b7cd4632509f93.png";
import imgRectangle51 from "./6b77863a0e0f9b6012b0efb37aac144e79b949fd.png";
import imgRectangle16 from "./36aa077a82908d67f0d09bdd32db4b087faa640f.png";
import imgRectangle53 from "./b0959804658fb551cbffbd1cb609f8681a22629e.png";
import imgRectangle17 from "./088108e47778ce06fb920175df7891e3dd45f817.png";
import imgRectangle52 from "./17ad916d138ef8e74225fedf514f9f7a6888aa0e.png";
type DisplayProps = {
  className?: string;
  color?: "white";
  display?: "web";
...
function Group19() {
  return (
    <div className="absolute contents left-[324.07px] top-[621.61px]">
      <div className="absolute flex h-[21.391px] items-center justify-center left-[324.07px] top-[621.61px] w-[21.799px]">
        <div className="flex-none rotate-180">
          <div className="bg-[#e5e8ed] h-[21.391px] relative rounded-[2px] w-[21.799px]" />
        </div>
      </div>
      <IcRoundPlus className="absolute left-[328.67px] size-[12.597px] top-[626px]" />
    </div>
  );
}
...
function Group21() {
  return (
    <div className="absolute contents left-[272.94px] top-[621.61px]">
      <div className="absolute flex h-[21.391px] items-center justify-center left-[272.94px] top-[621.61px] w-[21.799px]">
        <div className="flex-none rotate-180">
          <div className="bg-[#d72b2b] h-[21.391px] relative rounded-[2px] w-[21.799px]" />
        </div>
      </div>
      <div className="absolute flex items-center justify-center left-[274.43px] size-[18.829px] top-[622.89px]">
...
function Group20() {
  return (
    <div className="absolute contents left-[272.94px] top-[621.61px]">
      ...
      <IconsCommonsMinus className="absolute h-[14.261px] left-[277.49px] overflow-clip top-[625.17px] w-[12.716px]" />
      <Group21 />
    </div>
  );
}
...
function Group18() {
  return (
    <div className="absolute contents left-[12.98px] top-[621.61px]">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Roboto:Medium','Noto_Sans_KR:Medium',sans-serif] font-medium justify-center leading-[0] left-[12.98px] text-[#222] text-[14px] top-[632.3px] w-[95.649px]" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[normal]">메뉴 명</p>
      </div>
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Roboto:Medium','Noto_Sans_KR:Medium',sans-serif] font-medium justify-center leading-[0] left-[12.98px] text-[12px] text-black top-[671.45px] w-[95.649px]" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[normal]">39,000원</p>
      </div>
      <Group19 />
      <Group20 />
...
function Group23() {
  return (
    <div className="absolute contents left-[324.07px] top-[566.5px]">
      <div className="absolute flex h-[21.391px] items-center justify-center left-[324.07px] top-[566.5px] w-[21.799px]">
        <div className="flex-none rotate-180">
          <div className="bg-[#e5e8ed] h-[21.391px] relative rounded-[2px] w-[21.799px]" />
        </div>
      </div>
      <IcRoundPlus className="absolute left-[328.67px] size-[12.597px] top-[570.9px]" />
    </div>
  );
}
...
function Group24() {
  return (
    <div className="absolute contents left-[272.94px] top-[566.5px]">
      <div className="absolute flex h-[21.391px] items-center justify-center left-[272.94px] top-[566.5px] w-[21.799px]">
        <div className="flex-none rotate-180">
          <div className="bg-[#e5e8ed] h-[21.391px] relative rounded-[2px] w-[21.799px]" />
        </div>
      </div>
      <IconsCommonsMinus className="absolute h-[14.261px] left-[277.49px] overflow-clip top-[570.07px] w-[12.716px]" />
    </div>
  );
}
...
function Group22() {
  return (
    <div className="absolute contents left-[12.98px] top-[566.5px]">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Roboto:Medium','Noto_Sans_KR:Medium',sans-serif] font-medium justify-center leading-[0] left-[12.98px] text-[#222] text-[14px] top-[577.2px] w-[95.649px]" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[normal]">메뉴 명</p>
      </div>
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Roboto:Medium','Noto_Sans_KR:Medium',sans-serif] font-medium justify-center leading-[0] left-[12.98px] text-[12px] text-black top-[598.92px] w-[95.649px]" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[normal]">18,000원</p>
      </div>
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Roboto:Medium','Noto_Sans_KR:Medium',sans-serif] font-medium justify-center leading-[0] left-[209.58px] text-[#0f62fe] text-[12px] top-[577.9px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[normal]">36,000원</p>
      </div>
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Roboto:Medium','Noto_Sans_KR:Medium',sans-serif] font-medium justify-center leading-[0] left-[209.58px] text-[#0f62fe] text-[12px] top-[632.3px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[normal]">39,500원</p>
      </div>
      <Group23 />
      <Group24 />
    </div>
...
function Frame6() {
  return (
    <div className="absolute flex items-center justify-center left-[110.84px] size-[20px] top-[531.5px]">
      <div className="flex-none rotate-180">
        <div className="relative size-[20px]">
          <div className="absolute bg-[#e5e8ed] left-0 rounded-[2px] size-[20px] top-[2.55px]" />
          <div className="absolute flex items-center justify-center left-[6px] top-[5.05px]">
            <div className="flex-none rotate-180">
              <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative text-[12px] text-black whitespace-nowrap">3</p>
            </div>
          </div>
        </div>
      </div>
...
function Group2() {
  return (
    <div className="absolute contents left-[-1px] top-[490.01px]">
      <div className="absolute bg-white border border-[#f2f4f8] border-solid h-[307.82px] left-0 rounded-tl-[4px] rounded-tr-[4px] shadow-[1px_2px_6px_1px_rgba(0,0,0,0.2)] top-[492.18px] w-[360px]" />
      <div className="absolute flex h-[21.534px] items-center justify-center left-[114.36px] top-[491.01px] w-[132px]">
        <div className="-scale-y-100 flex-none">
          <div className="h-[21.534px] relative w-[132px]">
            <img alt="" className="absolute block inset-0 max-w-none size-full" height="21.534" src={imgRectangle57} width="132" />
          </div>
        </div>
      </div>
      <div className="absolute bg-[#0f62fe] left-[254.36px] min-w-[18px] rounded-[2px] size-[20px] top-[493.05px]" data-name="화면번호">
      ...
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Roboto:Bold','Noto_Sans_KR:Bold',sans-serif] font-bold justify-center leading-[0] left-[290.2px] text-[#0f62fe] text-[14px] top-[708.56px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[normal]">75,500원</p>
      </div>
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Roboto:Medium','Noto_Sans_KR:Medium',sans-serif] font-medium justify-center leading-[0] left-[12.98px] text-[#222] text-[14px] top-[707.56px] w-[93.86px]" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[normal]">총 결제 금액</p>
      </div>
      <div className="absolute h-0 left-[10.27px] top-[688.04px] w-[336.934px]">
      ...
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Roboto:Medium',sans-serif] font-medium justify-center leading-[0] left-[305.23px] text-[#222] text-[14px] top-[630.94px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[normal]">1</p>
      </div>
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Roboto:Medium',sans-serif] font-medium justify-center leading-[0] left-[305.23px] text-[#222] text-[14px] top-[575.87px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[normal]">2</p>
      </div>
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Roboto:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal justify-center leading-[0] left-[12.98px] text-[#999] text-[10px] top-[655.45px] w-[205.62px]" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[normal]">메뉴 옵션 명 (500원)</p>
      </div>
      <Group18 />
      <Group22 />
      <p className="[word-break:break-word] absolute font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[normal] left-[38.03px] not-italic text-[#333] text-[16px] top-[530px] whitespace-nowrap">장바구니</p>
      <div className="absolute h-[17.868px] left-[12.98px] top-[530px] w-[15.239px]" data-name="Icon">
        <div className="absolute inset-[-5.6%_-6.56%]">
          <svg className="block size-full" fill="none" height="19.8677" preserveAspectRatio="none" viewBox="0 0 17.2393 19.8677" width="17.2393">
            <path d={svgPaths.p2762fa80} id="Icon" stroke="#999999" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          </svg>
        </div>
      </div>
      <Frame6 />
      <div className="absolute flex h-[123.796px] items-center justify-center left-[7.27px] top-[557.91px] w-[345.033px]">
        <div className="-scale-y-100 flex-none">
          <div className="h-[123.796px] relative w-[345.033px]">
            <img alt="" className="absolute block inset-0 max-w-none size-full" height="123.796" src={imgRectangle51} width="345.033" />
          </div>
        </div>
      </div>
      <div className="absolute bg-[#0f62fe] left-[170px] min-w-[18px] rounded-[2px] size-[20px] top-[527.93px]" data-name="화면번호">
        <div aria-hidden className="absolute border-2 border-[#195edf] border-solid inset-[-1px] pointer-events-none rounded-[3px]" />
        <div className="flex flex-row items-center justify-center min-w-[inherit] size-full">
          <div className="content-stretch flex items-center justify-center min-w-[inherit] px-[6px] relative size-full">
            <div className="[word-break:break-word] flex flex-[1_0_0] flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] min-w-px not-italic relative text-[12px] text-center text-white">
      ...
      <div className="absolute h-[21.953px] left-[191.58px] top-[537.48px] w-[25.089px]">
        <div className="absolute inset-[-25.16%_-2.99%_0_-2.99%]">
          <svg className="block size-full" fill="none" height="27.4761" preserveAspectRatio="none" viewBox="0 0 26.5887 27.4761" width="26.5887">
            <path d={svgPaths.p3dd5bb80} fill="#0F62FE" id="Vector 61" />
          </svg>
        </div>
      </div>
      <div className="absolute flex h-[85.063px] items-center justify-center left-[268.35px] top-[562.44px] w-[79.854px]">
        <div className="-scale-y-100 flex-none">
          <div className="h-[85.063px] relative w-[79.854px]">
            <img alt="" className="absolute block inset-0 max-w-none size-full" height="85.063" src={imgRectangle16} width="79.854" />
          </div>
        </div>
      </div>
      <div className="absolute bg-[#0f62fe] left-[324.97px] min-w-[18px] rounded-[2px] size-[20px] top-[649.45px]" data-name="화면번호">
        <div aria-hidden className="absolute border-2 border-[#195edf] border-solid inset-[-1px] pointer-events-none rounded-[3px]" />
        <div className="flex flex-row items-center justify-center min-w-[inherit] size-full">
          <div className="content-stretch flex items-center justify-center min-w-[inherit] px-[6px] relative size-full">
            <div className="[word-break:break-word] flex flex-[1_0_0] flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] min-w-px not-italic relative text-[12px] text-center text-white">
      ...
      <div className="absolute h-[11.895px] left-[279.16px] top-[647.82px] w-[44.503px]">
        <div className="absolute inset-[0_-1.69%_-46.43%_-1.69%]">
          <svg className="block size-full" fill="none" height="17.4175" preserveAspectRatio="none" viewBox="0 0 46.0027 17.4175" width="46.0027">
            <path d={svgPaths.p18144800} fill="#0F62FE" id="Vector 64" />
          </svg>
        </div>
      </div>
    </div>
...
function Desktop() {
  return (
    <div className="absolute border border-[#999] border-solid h-[800px] left-[-0.24px] overflow-clip top-0 w-[360px]" data-name="Desktop - 1">
      ...
      <Group1 />
      <Group2 />
      <div className="absolute bg-[#e5e8ed] h-[4.274px] left-[121.73px] rounded-[10px] top-[499.5px] w-[114.539px]" />
    </div>
  );
}
...
function Frame8() {
  return (
    <div className="absolute content-stretch flex items-center left-[10.38px] top-[730.11px] w-[339px]">
      <div className="bg-[#0f62fe] flex-[1_0_0] h-[48px] min-w-px relative" data-name="button">
        <div aria-hidden className="absolute border-2 border-[#0f62fe] border-solid inset-0 pointer-events-none" />
        <div className="flex flex-row items-center justify-center size-full">
          <div className="content-stretch flex items-center justify-center px-[12px] py-[16px] relative size-full">
...
function IPhone() {
  return (
    <div className="bg-white flex-[1_0_0] h-[800px] min-w-px overflow-clip relative" data-name="iPhone 17 - 1">
      ...
      <TextContainer10 />
      <Desktop />
      <div className="absolute flex h-[58.279px] items-center justify-center left-[7.39px] top-[725.83px] w-[345.033px]">
        <div className="-scale-y-100 flex-none">
          <div className="h-[58.279px] relative w-[345.033px]">
            <img alt="" className="absolute block inset-0 max-w-none size-full" height="58.279" src={imgRectangle53} width="345.033" />
          </div>
        </div>
      </div>
      <div className="absolute bg-[#0f62fe] left-[145.01px] min-w-[18px] rounded-[2px] size-[20px] top-[699.25px]" data-name="화면번호">
        <div aria-hidden className="absolute border-2 border-[#195edf] border-solid inset-[-1px] pointer-events-none rounded-[3px]" />
        <div className="flex flex-row items-center justify-center min-w-[inherit] size-full">
          <div className="content-stretch flex items-center justify-center min-w-[inherit] px-[6px] relative size-full">
            <div className="[word-break:break-word] flex flex-[1_0_0] flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] min-w-px not-italic relative text-[12px] text-center text-white">
      ...
      <div className="absolute h-[15.471px] left-[165.65px] top-[711.68px] w-[14.366px]">
      ...
      <Frame8 />
      <div className="absolute flex h-[30px] items-center justify-center left-[7.03px] top-[523px] w-[126.454px]">
        <div className="-scale-y-100 flex-none">
          <div className="h-[30px] relative w-[126.454px]">
            <img alt="" className="absolute block inset-0 max-w-none size-full" height="30" src={imgRectangle17} width="126.454" />
          </div>
        </div>
      </div>
      <div className="absolute bg-[#0f62fe] left-[138.64px] min-w-[18px] rounded-[2px] size-[20px] top-[527px]" data-name="화면번호">
        <div aria-hidden className="absolute border-2 border-[#195edf] border-solid inset-[-1px] pointer-events-none rounded-[3px]" />
        <div className="flex flex-row items-center justify-center min-w-[inherit] size-full">
          <div className="content-stretch flex items-center justify-center min-w-[inherit] px-[6px] relative size-full">
            <div className="[word-break:break-word] flex flex-[1_0_0] flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] min-w-px not-italic relative text-[12px] text-center text-white">
      ...
      <div className="absolute bg-[#0f62fe] left-[257.47px] min-w-[18px] rounded-[2px] size-[20px] top-[697.22px]" data-name="화면번호">
        <div aria-hidden className="absolute border-2 border-[#195edf] border-solid inset-[-1px] pointer-events-none rounded-[3px]" />
        <div className="flex flex-row items-center justify-center min-w-[inherit] size-full">
          <div className="content-stretch flex items-center justify-center min-w-[inherit] px-[6px] relative size-full">
            <div className="[word-break:break-word] flex flex-[1_0_0] flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] min-w-px not-italic relative text-[12px] text-center text-white">
      ...
      <div className="absolute flex h-[28.559px] items-center justify-center left-[283.97px] top-[692.94px] w-[68.459px]">
        <div className="-scale-y-100 flex-none">
          <div className="h-[28.559px] relative w-[68.459px]">
            <img alt="" className="absolute block inset-0 max-w-none size-full" height="28.559" src={imgRectangle52} width="68.459" />
          </div>
        </div>
      </div>
    </div>
...
function Frame() {
  return (
    <div className="content-stretch flex gap-[6px] items-center relative shrink-0 w-full">
      ...
      <p className="[word-break:break-word] font-['Inter:Semi_Bold','Noto_Sans_KR:Bold',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[20px] text-white w-[399px]">주문오더 장바구니 - N</p>
    </div>
  );
}
...
function Component3() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start py-[10px] relative shrink-0 w-full" data-name="타이틀">
      <Frame />
      <p className="[word-break:break-word] font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[16px] text-white w-[432px]">장바구니 리스트 활성화</p>
    </div>
  );
}
...
function Component5() {
  return (
    <div className="content-center flex flex-wrap gap-y-[12px] items-center relative shrink-0 w-full" data-name="설명">
      <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[normal] min-w-px not-italic relative text-[16px] text-white">장바구니 메뉴 리스트</p>
    </div>
  );
}
    ...
    <div className="relative shrink-0 w-full" data-name="컨텐츠-번호">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[10px] items-center px-[20px] relative size-full">
          <Component10 />
          <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Semi_Bold','Noto_Sans_KR:Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#666] text-[18px]">장바구니 수량</p>
        </div>
      </div>
    </div>
  );
...
function Component13() {
  return (
    <div className="content-center flex flex-[1_0_0] flex-wrap gap-y-[12px] items-center min-w-px relative" data-name="설명">
      <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[normal] min-w-px not-italic relative text-[#222] text-[16px]">타이틀 우측에 현재 담긴 총 메뉴 수량을 함께 표시하며, 수량 변경 시 실시간으로 반영되어야 한다.</p>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="컨텐츠-번호">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[10px] items-center px-[20px] relative size-full">
          <Component17 />
          <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Semi_Bold','Noto_Sans_KR:Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#666] text-[18px]">장바구니 메뉴 아이템</p>
        </div>
      </div>
    </div>
  );
...
function Component19() {
  return (
    <div className="content-center flex flex-[1_0_0] flex-wrap gap-y-[12px] items-center min-w-px relative" data-name="설명">
      <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[normal] min-w-px not-italic relative text-[#222] text-[16px]">장바구니에 담긴 개별 메뉴의 기본 정보(메뉴명/단가)와 선택된 옵션 정보(옵션명/옵션 추가 가격)를 노출하며, 수량 변경 시 (메뉴 단가 + 옵션 가격) × 수량으로 계산된 해당 아이템의 총 금액이 실시간으로 반영된다.</p>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="컨텐츠-번호">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[10px] items-center px-[20px] relative size-full">
          <Component23 />
          <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Semi_Bold','Noto_Sans_KR:Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#666] text-[18px]">수량 조절 버튼</p>
        </div>
      </div>
    </div>
  );
...
function Component25() {
  return (
    <div className="content-center flex flex-[1_0_0] flex-wrap gap-y-[12px] items-center min-w-px relative" data-name="설명">
      <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[normal] min-w-px not-italic relative text-[#222] text-[16px]">(+, -)버튼으로 수량을 조절하되 수량이 1개일 때는 - 버튼이 삭제 버튼(X 또는 휴지통)으로 동적 변경되며, 이를 클릭 시 해당 메뉴 아이템이 장바구니 리스트에서 즉시 삭제 처리된다.</p>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="컨텐츠-번호">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[10px] items-center px-[20px] relative size-full">
          <Component29 />
          <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Semi_Bold','Noto_Sans_KR:Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#666] text-[18px]">총 결제 금액 실시간 표기</p>
        </div>
      </div>
    </div>
  );
...
function Component31() {
  return (
    <div className="content-center flex flex-[1_0_0] flex-wrap gap-y-[12px] items-center min-w-px relative" data-name="설명">
      <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[normal] min-w-px not-italic relative text-[#222] text-[16px]">장바구니에 담긴 전체 메뉴 아이템의 총 금액을 통합 계산하여 하단에 노출하며, 리스트 내 항목 추가·삭제 또는 수량 변경 시 총 결제 금액이 실시간으로 변동되어 반영된다.</p>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="컨텐츠-번호">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[10px] items-center px-[20px] relative size-full">
          <Component35 />
          <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Semi_Bold','Noto_Sans_KR:Bold',sans-serif] font-semibold leading-[normal] min-w-px not-italic relative text-[#666] text-[18px]">주문하기 버튼</p>
        </div>
      </div>
    </div>
  );
...
function Component37() {
  return (
    <div className="content-center flex flex-[1_0_0] flex-wrap gap-y-[12px] items-center min-w-px relative" data-name="설명">
      <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[normal] min-w-px not-italic relative text-[#222] text-[16px]">하단 주문하기 버튼 클릭 시, 현재 장바구니에 담긴 메뉴 항목들을 최종 주문 건으로 접수하여 상태를 주문 상태로 변경 처리한다.</p>
    </div>
  );
}
...
export default function Component() {
  return (
    <div className="bg-white relative size-full" data-name="주문오더 - 장바구니 리스트 활성화">

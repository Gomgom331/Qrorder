import svgPaths from "./svg-lqrjbrn1ok";
...
function Group18() {
  return (
    <div className="absolute contents left-[73.5px] top-[350.5px]">
      <div className="-translate-x-1/2 -translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Roboto:Medium','Noto_Sans_KR:Medium',sans-serif] font-medium justify-center leading-[0] left-[179.5px] text-[#222] text-[14px] text-center top-[366.5px] whitespace-nowrap" style={{ fontVariationSettings: '"wdth" 100' }}>
        <p className="leading-[normal] mb-0 whitespace-pre">{`아래 버튼을 눌러 다시 시도하거나, `}</p>
        <p className="leading-[normal] whitespace-pre">메인으로 이동해 다시 주문해 주세요.</p>
      </div>
    </div>
  );
}
...
function Group19() {
  return (
    <div className="absolute contents left-[62px] top-[321.2px]">
      <p className="[word-break:break-word] absolute font-['Inter:Semi_Bold','Noto_Sans_KR:Bold',sans-serif] font-semibold leading-[normal] left-[63px] not-italic text-[#333] text-[18px] top-[322.2px] whitespace-nowrap">주문 연결이 원할하지 않습니다.</p>
    </div>
  );
}
...
function Component5() {
  return (
    <div className="content-center flex flex-wrap gap-y-[12px] items-center relative shrink-0 w-full" data-name="설명">
      <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[normal] min-w-px not-italic relative text-[16px] text-white">네트워크 지연 등으로 인해 주문접수가 안 된 경우</p>
    </div>
  );
}
...
function Component20() {
  return (
    <div className="content-center flex flex-[1_0_0] flex-wrap gap-y-[12px] items-center min-w-px relative" data-name="설명">
      <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[normal] min-w-px not-italic relative text-[#222] text-[16px]">응답 지연으로 멈춘 기존 주문 요청을 동일한 조건으로 서버에 재전송(Retry)하는 기능입니다.</p>
    </div>
  );
}
